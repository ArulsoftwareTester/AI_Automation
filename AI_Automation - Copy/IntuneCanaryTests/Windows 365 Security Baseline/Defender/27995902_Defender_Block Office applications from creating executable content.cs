...
{
    [TestFixture]
    public class Defender_27995902_BlockOfficeApplicationsFromCreatingExecutableContent : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Block Office applications from creating executable content");
        ...
        [Test]
        public async Task Test_27995902_Defender_BlockOfficeApplicationsFromCreatingExecutableContent()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27995902");
