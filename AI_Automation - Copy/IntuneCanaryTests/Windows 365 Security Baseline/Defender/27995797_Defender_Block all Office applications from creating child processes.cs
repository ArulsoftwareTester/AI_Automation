...
{
    [TestFixture]
    public class Defender_27995797_BlockAllOfficeApplicationsFromCreatingChildProcesses : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Block all Office applications from creating child processes");
        ...
        [Test]
        public async Task Test_27995797_Defender_BlockAllOfficeApplicationsFromCreatingChildProcesses()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27995797");
