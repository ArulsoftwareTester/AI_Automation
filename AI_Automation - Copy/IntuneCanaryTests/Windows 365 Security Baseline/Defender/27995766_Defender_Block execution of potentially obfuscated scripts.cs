...
{
    [TestFixture]
    public class Defender_27995766_BlockExecutionOfPotentiallyObfuscatedScripts : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Block execution of potentially obfuscated scripts");
        ...
        [Test]
        public async Task Test_27995766_Defender_BlockExecutionOfPotentiallyObfuscatedScripts()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27995766");
