...
{
    [TestFixture]
    public class Defender_27996053_HideExclusionsFromLocalAdmins : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Hide Exclusions From Local Admins");
        ...
        [Test]
        public async Task Test_27996053_Defender_HideExclusionsFromLocalAdmins()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27996053");
