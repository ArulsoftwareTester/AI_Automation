...
{
    [TestFixture]
    public class Defender_27894675_AllowArchiveScanning : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Allow Archive Scanning");
        ...
        [Test]
        public async Task Test_27894675_Defender_AllowArchiveScanning()
        {
            try
            {
