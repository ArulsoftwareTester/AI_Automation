...
{
    [TestFixture]
    public class Defender_27996046_EnableNetworkProtection : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Defender: Enable Network Protection");
        ...
        [Test]
        public async Task Test_27996046_Defender_EnableNetworkProtection()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27996046");
