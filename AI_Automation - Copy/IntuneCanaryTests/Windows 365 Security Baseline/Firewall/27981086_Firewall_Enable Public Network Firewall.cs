...
{
    [TestFixture]
    public class Firewall_27981086_EnablePublicNetworkFirewall : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Firewall: Enable Public Network Firewall");
        ...
        [Test]
        public async Task Test_27981086_Firewall_EnablePublicNetworkFirewall()
        {
            try
            {
