...
namespace IntuneCanaryTests
{
    ...
    public class ConfigureWindowsDefenderSmartScreen : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Administrative Templates - File Explorer - Configure Windows Defender SmartScreen Test");
        ...
        public async Task Test_28036965_AdministrativeTemplatesFileExplorerConfigureWindowsDefenderSmartScreen()
        {
            try
            {
                Console.WriteLine("Test_28036965_AdministrativeTemplatesFileExplorerConfigureWindowsDefenderSmartScreen started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_28036965");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_28036965");
