...
{
    [TestFixture]
    public class TurnOffHeapTerminationOnCorruption : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Administrative Templates - File Explorer - Turn off heap termination on corruption Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27997688");
            _test.Info("Category: Administrative Templates - File Explorer");
        }


        [Test]
        public async Task Test_27997688_AdministrativeTemplatesFileExplorerTurnOffHeapTerminationOnCorruption()
        {
            try
            {
                Console.WriteLine("Test_27997688_AdministrativeTemplatesFileExplorerTurnOffHeapTerminationOnCorruption started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27997688");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27997688");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27997688");
