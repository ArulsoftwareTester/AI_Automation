...
{
    [TestFixture]
    public class T27895551_AccountLogonLogoffAuditLogon : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Auditing - Account Logon Logoff Audit Logon");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27895551");
            _test.Info("Category: Auditing");
        }

        [Test]
        public async Task Test_27895551_AccountLogonLogoffAuditLogon()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27895551");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27895551");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27895551");
