...
{
    [TestFixture]
    public class T27975584_DetailedTrackingAuditPNPActivity : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Auditing - Detailed Tracking Audit PNP Activity");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27975584");
            _test.Info("Category: Auditing");
        }

        [Test]
        public async Task Test_27975584_DetailedTrackingAuditPNPActivity()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27975584");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27975584");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27975584");
