...
{
    [TestFixture]
    public class TurnOffRoutineRemediation : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Administrative Templates - Microsoft Defender Antivirus - Turn off routine remediation Test");
        ...
        [Test]
        public async Task Test_27997546_AdministrativeTemplatesMicrosoftDefenderAntivirusTurnOffRoutineRemediation()
        {
            try
            {
                Console.WriteLine("Test_27997546_AdministrativeTemplatesMicrosoftDefenderAntivirusTurnOffRoutineRemediation started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27997546");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27997546");
