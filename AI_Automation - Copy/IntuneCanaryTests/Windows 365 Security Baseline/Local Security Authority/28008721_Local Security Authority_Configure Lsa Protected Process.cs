...
{
    [TestFixture]
    public class LocalSecurityAuthority_28008721_ConfigureLsaProtectedProcess : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Local Security Authority: Configure Lsa Protected Process");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28008721");
            _test.Info("Category: Security Baseline - Local Security Authority");
        }

        [Test]
        public async Task Test_28008721_LocalSecurityAuthority_ConfigureLsaProtectedProcess()
        {
            try
            {
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_28008721");
