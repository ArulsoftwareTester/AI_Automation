...
{
    [TestFixture]
    public class DeviceGuard_28008968_EnableVirtualizationBasedSecurity : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Device Guard: Enable Virtualization Based Security");
        ...
        [Test]
        public async Task Test_28008968_DeviceGuard_EnableVirtualizationBasedSecurity()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_28008968");
