...
{
    [TestFixture]
    public class T21789574_Microsoft_Word_2016_Set_Default_File_Block_Behavior_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Set Default File Block Behavior User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21789574");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21789574_Microsoft_Word_2016_Set_Default_File_Block_Behavior_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Microsoft Word 2016",
                                                        "Set default file block behavior (User)",  // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value - Config 1
                                                        "Set default file block behavior (User)",  // Child dropdown name
                                                        "Blocked files are not opened",  // Child dropdown value - Config 2
                                                        "Word Options > Security > Trust Center > File Block Settings",  // Parent path
                                                        ""                                // Child path
                                                    );    
                _test?.Pass("Successfully created NEW Profile with Config 1: Parent=Enabled, Child=Blocked files are not opened"); 
                ...
                await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "Set default file block behavior (User)",  // Child dropdown name
                                                        "Blocked files open in Protected View and can not be edited",  // Child dropdown value - Config 3
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21789574");
