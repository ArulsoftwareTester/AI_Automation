...
namespace IntuneCanaryTests
{
    ...
    public class T21801448_Microsoft_Project_2016_Allow_Trusted_Locations_On_The_Network_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Project 2016 Allow Trusted Locations On The Network User Test");
