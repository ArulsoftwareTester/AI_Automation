...
{
    [TestFixture]
    public class T21786388_Microsoft_Outlook_2016_Prevent_Users_From_Customizing_Attachment_Security_Settings_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Prevent Users From Customizing Attachment Security Settings User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21786388");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21786388_Microsoft_Outlook_2016_Prevent_Users_From_Customizing_Attachment_Security_Settings_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Prevent users from customizing attachment security settings (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21786388");
