...
namespace IntuneCanaryTests
{
    ...
    public class T21789823_Microsoft_Outlook_2016_Display_Level_1_Attachments_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Outlook 2016 Display Level 1 Attachments User Test");
        ...
        public async Task Test_21789823_Microsoft_Outlook_2016_Display_Level_1_Attachments_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21789823");
