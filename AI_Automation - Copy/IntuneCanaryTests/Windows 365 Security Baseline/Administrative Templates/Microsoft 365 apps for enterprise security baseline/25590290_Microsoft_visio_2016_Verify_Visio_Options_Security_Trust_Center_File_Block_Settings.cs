...
namespace IntuneCanaryTests
{
    ...
    public class T25590290_Microsoft_Visio_2016_Verify_Visio_Options_Security_Trust_Center_File_Block_Settings : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Visio 2016 Verify Visio Options Security Trust Center File Block Settings Test");
