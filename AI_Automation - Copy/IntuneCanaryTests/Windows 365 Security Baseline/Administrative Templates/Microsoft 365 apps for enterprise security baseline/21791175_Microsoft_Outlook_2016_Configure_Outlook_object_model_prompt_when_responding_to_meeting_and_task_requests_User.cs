...
{
    [TestFixture]
    public class T21791175_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Responding_To_Meeting_And_Task_Requests_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Configure Outlook Object Model Prompt When Responding To Meeting And Task Requests User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21791175");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21791175_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Responding_To_Meeting_And_Task_Requests_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Set Configure Outlook object model prompt when responding to meeting and task requests (User)", // Child dropdown name
                ...
                _test?.Pass("Successfully edited Profile with Config 3: Parent=Not configured");
                ...
                await TestInitialize.LogSuccess(Page, "Test 21791175 completed successfully - All configurations tested", "Test_Complete_21791175");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21791175 completed successfully!");
                ...
                Console.WriteLine("3. Config 3: Parent=Not configured");
                Console.WriteLine("Configure Outlook object model prompt when responding to meeting and task requests");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21791175");
