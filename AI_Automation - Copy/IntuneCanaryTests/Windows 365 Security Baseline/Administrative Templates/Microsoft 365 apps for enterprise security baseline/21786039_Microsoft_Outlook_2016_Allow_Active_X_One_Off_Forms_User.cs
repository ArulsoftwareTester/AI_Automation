...
{
    [TestFixture]
    public class T21786039_Microsoft_Outlook_2016_Allow_Active_X_One_Off_Forms_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Allow Active X One Off Forms User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21786039");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21786039_Microsoft_Outlook_2016_Allow_Active_X_One_Off_Forms_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow Active X One Off Forms (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21786039 completed successfully - All configurations tested", "Test_Complete_21786039");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21786039 completed successfully!");
                ...
                Console.WriteLine("Allow Active X One Off Forms");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21786039");
