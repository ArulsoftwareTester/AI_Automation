...
{
    [TestFixture]
    public class T21795225_Microsoft_Word_2016_Set_Document_Behavior_If_File_Validation_Fails_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Set Document Behavior If File Validation Fails User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21795225");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21795225_Microsoft_Word_2016_Set_Document_Behavior_If_File_Validation_Fails_User()
        {
                        try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21795225");
