...
namespace IntuneCanaryTests
{
    ...
    public class T21789700_Microsoft_Outlook_2016_Junk_E_Mail_Protection_Level_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Outlook 2016 Junk E Mail Protection Level User Test");
        ...
        public async Task Test_21789700_Microsoft_Outlook_2016_Junk_E_Mail_Protection_Level_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21789700");
