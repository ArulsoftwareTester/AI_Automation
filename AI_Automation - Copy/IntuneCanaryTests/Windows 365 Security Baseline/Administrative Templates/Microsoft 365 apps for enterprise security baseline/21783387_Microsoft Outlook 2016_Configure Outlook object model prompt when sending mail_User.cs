...
namespace IntuneCanaryTests
{
    ...
    public class T21783387_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Sending_Mail_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Outlook 2016 Configure Outlook Object Model Prompt When Sending Mail User Test");
        ...
        public async Task Test_21783387_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Sending_Mail_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21783387");
