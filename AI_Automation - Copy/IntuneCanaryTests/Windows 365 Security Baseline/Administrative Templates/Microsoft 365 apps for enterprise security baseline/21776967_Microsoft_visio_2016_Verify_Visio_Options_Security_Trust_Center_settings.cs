...
{
    [TestFixture]
    public class T21776967_Microsoft_Visio_2016_Verify_Visio_Options_Security_Trust_Center_Settings : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Visio 2016 Verify Visio Options Security Trust Center Settings Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21776967");
            _test.Info("Category: Security Baseline Configuration - Microsoft Visio 2016");
            _test.Info("Parent: Microsoft Visio 2016");
            _test.Info("Description: End-to-end test for Visio Options Security Trust Center with 2 settings");
        }

        [Test]
        public async Task Test_21776967_Microsoft_Visio_2016_Verify_Visio_Options_Security_Trust_Center_Settings()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21776967");
                ...
                Console.WriteLine($"Test 21776967 FAILED: {ex.Message}");
                throw;
            }
        }
