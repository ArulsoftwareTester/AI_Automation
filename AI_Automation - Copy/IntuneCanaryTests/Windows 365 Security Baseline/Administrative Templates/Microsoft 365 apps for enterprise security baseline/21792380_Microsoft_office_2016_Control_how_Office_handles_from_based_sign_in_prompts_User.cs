...
{
    [TestFixture]
    public class T21792380_Microsoft_Office_2016_Control_How_Office_Handles_From_Based_Sign_In_Prompts_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Control How Office Handles From Based Sign In Prompts User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21792380");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21792380_Microsoft_Office_2016_Control_How_Office_Handles_From_Based_Sign_In_Prompts_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Control how Office handles from-based sign-in prompts (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21792380");
