...
namespace IntuneCanaryTests
{
    ...
    public class T21800183_Microsoft_Office_2016_Disable_Smart_Document_S_Use_Of_Marnifests_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Disable Smart Document S Use Of Marnifests User Test");
        ...
        public async Task Test_21800183_Microsoft_Office_2016_Disable_Smart_Document_S_Use_Of_Marnifests_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disable Smart Document's use of marnifests (User)",              // Parent dropdown name
