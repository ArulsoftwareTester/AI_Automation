...
namespace IntuneCanaryTests
{
    ...
    public class T21791641_Microsoft_Word_2016_Word_95_Binary_Documents_And_Templates_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Word 95 Binary Documents And Templates User Test");
        ...
        public async Task Test_21791641_Microsoft_Word_2016_Word_95_Binary_Documents_And_Templates_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Word 95 binary documents and templates (User)",              // Parent dropdown name
