...
namespace IntuneCanaryTests
{
    ...
    public class T21796309_Microsoft_Word_2016_Turn_Off_File_Validation_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Turn Off File Validation User Test");
