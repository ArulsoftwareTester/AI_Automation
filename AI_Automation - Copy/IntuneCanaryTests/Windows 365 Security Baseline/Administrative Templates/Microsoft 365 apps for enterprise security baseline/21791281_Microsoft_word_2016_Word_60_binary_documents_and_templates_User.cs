...
namespace IntuneCanaryTests
{
    ...
    public class T21791281_Microsoft_Word_2016_Word_6_0_Binary_Documents_And_Templates_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Word 6 0 Binary Documents And Templates User Test");
        ...
        public async Task Test_21791281_Microsoft_Word_2016_Word_6_0_Binary_Documents_And_Templates_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Word 6.0 binary documents and templates (User)",              // Parent dropdown name
