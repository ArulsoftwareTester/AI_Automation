...
namespace IntuneCanaryTests
{
    ...
    public class T25591517_Microsoft_Access_2016_Application_Settings_Security_Trust_Center_Trusted_Locations : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Access 2016 Application Settings Security Trust Center Trusted Locations Test");
        ...
        public async Task Test_25591517_Microsoft_Access_2016_Application_Settings_Security_Trust_Center_Trusted_Locations()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow Trusted Locations on the network (User)",              // Parent dropdown name
