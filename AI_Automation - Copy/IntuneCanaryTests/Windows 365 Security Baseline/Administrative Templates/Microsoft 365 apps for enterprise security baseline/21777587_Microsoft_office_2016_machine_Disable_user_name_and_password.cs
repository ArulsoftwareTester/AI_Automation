...
{
    [TestFixture]
    public class T21777587_Microsoft_Office_2016_Machine_Disable_User_Name_And_Password : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Disable User Name And Password Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21777587");
        ...
        [Test]
        public async Task Test_21777587_Microsoft_Office_2016_Machine_Disable_User_Name_And_Password()
        {
                        try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21777587");
