...
namespace IntuneCanaryTests
{
    ...
    public class T25589606_Microsoft_Excel_2016_Excel_Options_Save : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Save Test");
        ...
        public async Task Test_25589606_Microsoft_Excel_2016_Excel_Options_Save()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disable AutoRepublish (User)",              // Parent dropdown name
