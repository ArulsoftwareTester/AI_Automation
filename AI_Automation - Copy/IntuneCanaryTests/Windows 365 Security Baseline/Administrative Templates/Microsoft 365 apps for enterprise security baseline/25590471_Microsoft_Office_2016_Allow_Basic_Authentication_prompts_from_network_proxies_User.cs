...
{
    [TestFixture]
    public class T25590471_Microsoft_Office_2016_Allow_Basic_Authentication_Prompts_From_Network_Proxies_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Allow Basic Authentication Prompts From Network Proxies User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25590471");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25590471_Microsoft_Office_2016_Allow_Basic_Authentication_Prompts_From_Network_Proxies_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow Basic Authentication prompts from network proxies (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25590471");
