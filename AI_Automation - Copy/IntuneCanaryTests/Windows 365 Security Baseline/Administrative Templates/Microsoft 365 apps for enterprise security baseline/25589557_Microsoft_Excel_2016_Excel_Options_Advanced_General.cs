...
{
    [TestFixture]
    public class T25589557_Microsoft_Excel_2016_Excel_Options_Advanced_General : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Advanced General Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25589557");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25589557_Microsoft_Excel_2016_Excel_Options_Advanced_General()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Load pictures from Web pages not created in Excel (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25589557");
