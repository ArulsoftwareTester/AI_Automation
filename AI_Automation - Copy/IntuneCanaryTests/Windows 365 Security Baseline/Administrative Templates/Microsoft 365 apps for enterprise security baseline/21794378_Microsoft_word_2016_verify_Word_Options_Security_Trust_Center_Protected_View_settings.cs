...
namespace IntuneCanaryTests
{
    ...
    public class T21794378_Microsoft_Word_2016_Verify_Word_Options_Security_Trust_Center_Protected_View_Settings : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Verify Word Options Security Trust Center Protected View Settings Test");
