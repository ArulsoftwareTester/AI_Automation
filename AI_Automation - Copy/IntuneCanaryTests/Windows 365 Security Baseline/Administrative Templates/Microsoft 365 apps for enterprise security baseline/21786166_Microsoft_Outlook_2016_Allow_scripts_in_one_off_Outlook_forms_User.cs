...
namespace IntuneCanaryTests
{
    ...
    public class T21786166_Microsoft_Outlook_2016_Allow_Scripts_In_One_Off_Outlook_Forms_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Allow Scripts In One Off Outlook Forms User Test");
        ...
        public async Task Test_21786166_Microsoft_Outlook_2016_Allow_Scripts_In_One_Off_Outlook_Forms_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow scripts in one-off Outlook forms (User)", // Child dropdown name
