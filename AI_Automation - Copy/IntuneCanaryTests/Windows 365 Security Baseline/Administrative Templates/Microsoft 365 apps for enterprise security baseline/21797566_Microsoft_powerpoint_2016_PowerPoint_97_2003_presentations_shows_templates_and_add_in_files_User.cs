...
{
    [TestFixture]
    public class T21797566_Microsoft_PowerPoint_2016_PowerPoint_97_2003_Presentations_Shows_Templates_And_Add_In_Files_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 PowerPoint 97 2003 Presentations Shows Templates And Add In Files User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21797566");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21797566_Microsoft_PowerPoint_2016_PowerPoint_97_2003_Presentations_Shows_Templates_And_Add_In_Files_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "PowerPoint 97-2003 presentations, shows, templates and add-in files (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21797566");
