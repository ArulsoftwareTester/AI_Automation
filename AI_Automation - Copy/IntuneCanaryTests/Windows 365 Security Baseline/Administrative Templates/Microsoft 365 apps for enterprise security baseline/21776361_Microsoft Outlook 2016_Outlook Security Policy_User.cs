...
namespace IntuneCanaryTests
{
    ...
    public class T21776361_Microsoft_Outlook_2016_Outlook_Security_Policy_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Outlook 2016 Outlook Security Policy User Test");
        ...
        public async Task Test_21776361_Microsoft_Outlook_2016_Outlook_Security_Policy_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21776361");
