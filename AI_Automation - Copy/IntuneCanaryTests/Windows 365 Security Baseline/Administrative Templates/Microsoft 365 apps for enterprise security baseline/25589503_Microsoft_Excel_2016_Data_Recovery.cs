...
{
    [TestFixture]
    public class T25589503_Microsoft_Excel_2016_Data_Recovery : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Data Recovery Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25589503");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25589503_Microsoft_Excel_2016_Data_Recovery()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Do not show data extraction options when opening corrupt workbooks (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25589503");
