...
namespace IntuneCanaryTests
{
    ...
    public class T21778034_Microsoft_Outlook_2016_Authentication_With_Exchange_Server_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Outlook 2016 Authentication With Exchange Server User Test");
        ...
        public async Task Test_21778034_Microsoft_Outlook_2016_Authentication_With_Exchange_Server_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21778034");
