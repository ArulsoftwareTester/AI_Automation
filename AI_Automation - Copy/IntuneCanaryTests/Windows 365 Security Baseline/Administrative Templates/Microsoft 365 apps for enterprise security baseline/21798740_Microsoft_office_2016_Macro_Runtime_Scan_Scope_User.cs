...
namespace IntuneCanaryTests
{
    ...
    public class T21798740_Microsoft_Office_2016_Macro_Runtime_Scan_Scope_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Macro Runtime Scan Scope User Test");
        ...
        public async Task Test_21798740_Microsoft_Office_2016_Macro_Runtime_Scan_Scope_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Macro Runtime Scan Scope (User)",              // Parent dropdown name
