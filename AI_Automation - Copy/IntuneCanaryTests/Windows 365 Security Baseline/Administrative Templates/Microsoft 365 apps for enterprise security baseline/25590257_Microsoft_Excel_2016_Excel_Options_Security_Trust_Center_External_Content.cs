...
{
    [TestFixture]
    public class T25590257_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center_External_Content : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Security Trust Center External Content Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25590257");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25590257_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center_External_Content()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Always prevent untrusted Microsoft Query files from opening (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25590257");
