...
{
    [TestFixture]
    public class T21787983_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Accessing_An_Address_Book_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Configure Outlook Object Model Prompt When Accessing An Address Book User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21787983");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21787983_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Accessing_An_Address_Book_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Configure Outlook object model prompt when accessing an address book (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21787983 completed successfully - All configurations tested", "Test_Complete_21787983");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21787983 completed successfully!");
                ...
                Console.WriteLine("Configure Outlook object model prompt when accessing an address book");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21787983");
