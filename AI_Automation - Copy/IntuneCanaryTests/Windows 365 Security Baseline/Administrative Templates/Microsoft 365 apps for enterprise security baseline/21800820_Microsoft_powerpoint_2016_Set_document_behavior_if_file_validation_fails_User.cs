...
{
    [TestFixture]
    public class T21800820_Microsoft_PowerPoint_2016_Set_Document_Behavior_If_File_Validation_Fails_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Set Document Behavior If File Validation Fails User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21800820");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21800820_Microsoft_PowerPoint_2016_Set_Document_Behavior_If_File_Validation_Fails_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Set document behavior if file validation fails (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21800820");
