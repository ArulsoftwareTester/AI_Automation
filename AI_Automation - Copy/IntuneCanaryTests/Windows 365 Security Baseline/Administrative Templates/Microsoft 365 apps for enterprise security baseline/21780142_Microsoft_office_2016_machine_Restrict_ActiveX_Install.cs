...
{
    [TestFixture]
    public class T21780142_Microsoft_Office_2016_Machine_Restrict_ActiveX_Install : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Restrict ActiveX Install Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21780142");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21780142_Microsoft_Office_2016_Machine_Restrict_ActiveX_Install()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Restrict ActiveX Install",       // Parent dropdown name
                                                        "Enabled",                        // Config 1
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                                                        "",                               // Parent path
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21780142");
