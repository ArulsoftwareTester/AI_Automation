...
{
    [TestFixture]
    public class T21782899_Microsoft_Outlook_2016_Allow_Hyperlinks_In_Suspected_Phishing_E_Mail_Messages_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Allow Hyperlinks In Suspected Phishing E Mail Messages User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21782899");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21782899_Microsoft_Outlook_2016_Allow_Hyperlinks_In_Suspected_Phishing_E_Mail_Messages_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow hyperlinks in suspected phishing e-mail messages (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21782899");
