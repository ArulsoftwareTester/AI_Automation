...
namespace IntuneCanaryTests
{
    ...
    public class T21797629_Microsoft_Office_2016_Load_Controls_In_Froms3_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Load Controls In Froms3 User Test");
        ...
        public async Task Test_21797629_Microsoft_Office_2016_Load_Controls_In_Froms3_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Load Controls in Forms3 (User)",              // Parent dropdown name
