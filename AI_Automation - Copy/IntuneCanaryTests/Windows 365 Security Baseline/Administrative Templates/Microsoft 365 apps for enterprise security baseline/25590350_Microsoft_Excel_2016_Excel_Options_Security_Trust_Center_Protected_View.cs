...
{
    [TestFixture]
    public class T25590350_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center_Protected_View : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Security Trust Center Protected View Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25590350");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25590350_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center_Protected_View()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Always open untrusted database files in Protected View (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25590350");
