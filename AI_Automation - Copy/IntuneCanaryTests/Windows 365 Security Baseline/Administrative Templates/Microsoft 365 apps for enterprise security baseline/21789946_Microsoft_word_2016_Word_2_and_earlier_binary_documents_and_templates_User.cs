...
{
    [TestFixture]
    public class T21789946_Microsoft_Word_2016_Word_2_And_Earlier_Binary_Documents_And_Templates_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Word 2 And Earlier Binary Documents And Templates User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21789946");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21789946_Microsoft_Word_2016_Word_2_And_Earlier_Binary_Documents_And_Templates_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Microsoft Word 2016",
                                                        "Word 2 and earlier binary documents and templates (User)", // Parent dropdown name
                                                        "Enabled",                        // Parent value - Config 1
                                                        "File block setting: (User)",     // Child dropdown name
                                                        "",                               // No child value for Config 1
                                                        "Word Options > Security > Trust Center > File Block Settings",  // Parent path
                                                        ""                                // Child path
                                                    );    
                _test?.Pass("Successfully created NEW Profile with Config 1: Parent=Enabled");
                ...
                _test?.Pass("Successfully edited Profile with Config 2: Child=Open/Save blocked, use open policy");
                ...
                _test?.Pass("Successfully edited Profile with Config 3: Child=Do not block");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21789946");
