...
{
    [TestFixture]
    public class T21789883_Microsoft_Office_2016_ActiveX_Control_Initialion_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 ActiveX Control Initialion User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21789883");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21789883_Microsoft_Office_2016_ActiveX_Control_Initialion_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "ActiveX Control Initialization (User)",  // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value - Config 1
                                                        "ActiveX Control Initialion (User)",  // Child dropdown name
                                                        "1",                              // Child dropdown value - Config 1
                                                        "Security Settings",              // Parent path
                                                        ""                                // Child path
                                                    );    
                _test?.Pass("Successfully created NEW Profile with Config 1: Parent=Enabled, Child=1"); 
                ...
                await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "ActiveX Control Initialion (User)",  // Child dropdown name
                                                        "2",                              // Child dropdown value - Config 2
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21789883");
