...
namespace IntuneCanaryTests
{
    ...
    public class T25590520_Microsoft_Office_2016_Encryption_Mode_For_Information_Rights_Management_IRM_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Office 2016 Encryption Mode For Information Rights Management IRM User Test");
        ...
        public async Task Test_25590520_Microsoft_Office_2016_Encryption_Mode_For_Information_Rights_Management_IRM_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_25590520");
