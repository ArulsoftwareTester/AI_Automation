...
namespace IntuneCanaryTests
{
    ...
    public class T21792022_Microsoft_PowerPoint_2016_Run_Programs_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Run Programs User Test");
        ...
        public async Task Test_21792022_Microsoft_PowerPoint_2016_Run_Programs_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Run Programs (User)",              // Parent dropdown name
