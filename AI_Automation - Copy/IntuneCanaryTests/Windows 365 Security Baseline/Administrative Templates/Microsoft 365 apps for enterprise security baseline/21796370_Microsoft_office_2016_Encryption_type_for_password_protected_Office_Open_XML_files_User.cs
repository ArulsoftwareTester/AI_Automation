...
{
    [TestFixture]
    public class T21796370_Microsoft_Office_2016_Encryption_Type_For_Password_Protected_Office_Open_XML_Files_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Encryption Type For Password Protected Office Open XML Files User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21796370");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21796370_Microsoft_Office_2016_Encryption_Type_For_Password_Protected_Office_Open_XML_Files_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Encryption type for password protected Office Open XML files (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21796370");
