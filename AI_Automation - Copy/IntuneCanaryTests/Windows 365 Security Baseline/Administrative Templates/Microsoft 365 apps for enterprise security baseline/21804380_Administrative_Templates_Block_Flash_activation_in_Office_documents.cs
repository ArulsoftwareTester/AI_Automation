...
namespace IntuneCanaryTests
{
    ...
    public class T21804380_Administrative_Templates_Block_Flash_Activation_In_Office_Documents : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Administrative Templates Block Flash Activation In Office Documents Test");
        ...
        public async Task Test_21804380_Administrative_Templates_Block_Flash_Activation_In_Office_Documents()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Block Flash activation in Office documents",              // Parent dropdown name
