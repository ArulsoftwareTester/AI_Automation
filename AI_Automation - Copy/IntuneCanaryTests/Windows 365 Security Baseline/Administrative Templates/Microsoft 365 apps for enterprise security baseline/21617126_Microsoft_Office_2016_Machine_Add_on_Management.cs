...
{
    [TestFixture]
    public class T21617126_Microsoft_Office_2016_Machine_Add_on_Management : PageTest
    {
        ...
        public override BrowserNewContextOptions ContextOptions()
        {
            ...
            return new BrowserNewContextOptions
            {
                ...
                // Clear browser state for fresh session
                StorageState = null
            };
        }
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine - Add-on Management Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21617126");
            _test.Info("Category: Security Baseline Configuration - Microsoft Office 2016 (Machine)");
            _test.Info("Description: End-to-end test for Microsoft Office 2016 Add-on Management configuration");
        }

        [Test]
        public async Task Test_21617126_Microsoft_Office_2016_Machine_Add_on_Management()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21617126");
                ...
                Console.WriteLine($"========================================");
                Console.WriteLine($"Test 21617126 FAILED");
