...
{
    [TestFixture]
    public class T21788878_Microsoft_Outlook_2016_Set_Outlook_Object_Model_Custom_Actions_Execution_Prompt_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Set Outlook Object Model Custom Actions Execution Prompt User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21788878");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21788878_Microsoft_Outlook_2016_Set_Outlook_Object_Model_Custom_Actions_Execution_Prompt_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Set Outlook object model custom actions execution prompt (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21788878 completed successfully - All configurations tested", "Test_Complete_21788878");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21788878 completed successfully!");
                ...
                Console.WriteLine("Set Outlook object model custom actions execution prompt");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21788878");
