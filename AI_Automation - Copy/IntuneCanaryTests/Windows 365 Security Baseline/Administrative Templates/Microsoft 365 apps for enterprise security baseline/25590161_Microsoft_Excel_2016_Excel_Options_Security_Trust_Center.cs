...
{
    [TestFixture]
    public class T25590161_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Security Trust Center Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25590161");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25590161_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Block Excel XLL Add-ins that come from an untrusted source (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25590161");
