...
{
    [TestFixture]
    public class T21777385_Microsoft_Office_2016_Machine_Consistent_Mime_Handling : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Consistent Mime Handling Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21777385");
        ...
        [Test]
        public async Task Test_21777385_Microsoft_Office_2016_Machine_Consistent_Mime_Handling()
        {
                        try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21777385");
