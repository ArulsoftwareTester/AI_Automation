...
namespace IntuneCanaryTests
{
    ...
    public class T21804687_Administrative_Templates_Restrict_Legacy_Jscript_Execution_For_Office : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Administrative Templates Restrict Legacy Jscript Execution For Office Test");
        ...
        public async Task Test_21804687_Administrative_Templates_Restrict_Legacy_Jscript_Execution_For_Office()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Restrict legacy Jscript execution for Office",              // Parent dropdown name
