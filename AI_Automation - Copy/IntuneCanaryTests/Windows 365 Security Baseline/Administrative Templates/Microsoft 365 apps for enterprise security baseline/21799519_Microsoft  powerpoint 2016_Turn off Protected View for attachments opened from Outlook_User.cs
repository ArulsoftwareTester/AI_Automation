...
namespace IntuneCanaryTests
{
    ...
    public class T21799519_Microsoft_PowerPoint_2016_Turn_Off_Protected_View_For_Attachments_Opened_From_Outlook_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft PowerPoint 2016 Turn Off Protected View For Attachments Opened From Outlook User Test");
        ...
        public async Task Test_21799519_Microsoft_PowerPoint_2016_Turn_Off_Protected_View_For_Attachments_Opened_From_Outlook_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21799519");
