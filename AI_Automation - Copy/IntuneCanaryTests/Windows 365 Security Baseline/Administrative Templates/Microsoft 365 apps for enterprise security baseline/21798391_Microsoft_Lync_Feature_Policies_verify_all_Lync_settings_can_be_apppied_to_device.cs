...
namespace IntuneCanaryTests
{
    ...
    public class T21798391_Microsoft_Lync_Feature_Policies_Verify_All_Lync_Settings_Can_Be_Apppied_To_Device : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Lync Feature Policies Verify All Lync Settings Can Be Apppied To Device Test");
        ...
        public async Task Test_21798391_Microsoft_Lync_Feature_Policies_Verify_All_Lync_Settings_Can_Be_Apppied_To_Device()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Configure SIP security mode",              // Parent dropdown name
