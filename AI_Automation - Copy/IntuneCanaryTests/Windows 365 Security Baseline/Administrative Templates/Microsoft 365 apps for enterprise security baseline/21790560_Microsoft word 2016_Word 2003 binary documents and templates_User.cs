...
namespace IntuneCanaryTests
{
    ...
    public class T21790560_Microsoft_Word_2016_Word_2003_Binary_Documents_And_Templates_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Word 2016 Word 2003 Binary Documents And Templates User Test");
        ...
        public async Task Test_21790560_Microsoft_Word_2016_Word_2003_Binary_Documents_And_Templates_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21790560");
