...
{
    [TestFixture]
    public class T21788292_Microsoft_Outlook_2016_Include_Internet_In_Safe_Zones_For_Automatic_Picture_Download_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Include Internet In Safe Zones For Automatic Picture Download User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21788292");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21788292_Microsoft_Outlook_2016_Include_Internet_In_Safe_Zones_For_Automatic_Picture_Download_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Include Internet in Safe Zones for Automatic Picture Download (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21788292");
