...
namespace IntuneCanaryTests
{
    ...
    public class T21793146_Microsoft_PowerPoint_2016_Turn_Off_File_Validation_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Turn Off File Validation User Test");
        ...
        public async Task Test_21793146_Microsoft_PowerPoint_2016_Turn_Off_File_Validation_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn off file validation (User)",              // Parent dropdown name
