...
namespace IntuneCanaryTests
{
    ...
    public class T25722892_Microsoft_Office_2016_Machine_Restrict_File_Download : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Restrict File Download Test");
        ...
        public async Task Test_25722892_Microsoft_Office_2016_Machine_Restrict_File_Download()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Restrict File Download",              // Parent dropdown name
