...
namespace IntuneCanaryTests
{
    ...
    public class T21798953_Microsoft_PowerPoint_2016_Do_Not_Open_Files_From_The_Internet_Zone_In_Protected_View_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Do Not Open Files From The Internet Zone In Protected View User Test");
        ...
        public async Task Test_21798953_Microsoft_PowerPoint_2016_Do_Not_Open_Files_From_The_Internet_Zone_In_Protected_View_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Do not open files from the Internet zone in Protected View (User)",              // Parent dropdown name
