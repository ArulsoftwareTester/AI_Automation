...
namespace IntuneCanaryTests
{
    ...
    public class T25590396_Microsoft_Excel_2016_Excel_Options_Security_Trust_Center_Trusted_Locations : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Security Trust Center Trusted Locations Test");
