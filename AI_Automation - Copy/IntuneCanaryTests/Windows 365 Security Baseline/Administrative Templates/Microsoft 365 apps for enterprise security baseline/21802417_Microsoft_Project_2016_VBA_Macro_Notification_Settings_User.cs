...
namespace IntuneCanaryTests
{
    ...
    public class T21802417_Microsoft_Project_2016_VBA_Macro_Notification_Settings_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Project 2016 VBA Macro Notification Settings User Test");
