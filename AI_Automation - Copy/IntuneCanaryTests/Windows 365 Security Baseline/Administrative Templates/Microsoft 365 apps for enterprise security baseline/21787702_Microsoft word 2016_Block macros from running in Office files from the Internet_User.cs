...
namespace IntuneCanaryTests
{
    ...
    public class T21787702_Microsoft_Word_2016_Block_Macros_From_Running_In_Office_Files_From_The_Internet_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Word 2016 Block Macros From Running In Office Files From The Internet User Test");
        ...
        public async Task Test_21787702_Microsoft_Word_2016_Block_Macros_From_Running_In_Office_Files_From_The_Internet_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21787702");
