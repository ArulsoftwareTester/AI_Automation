...
namespace IntuneCanaryTests
{
    ...
    public class T21799976_Microsoft_Office_2016_Allow_Mix_Of_Policy_And_User_Locations_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Allow Mix Of Policy And User Locations User Test");
        ...
        public async Task Test_21799976_Microsoft_Office_2016_Allow_Mix_Of_Policy_And_User_Locations_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow mix of policy and user locations (User)",              // Parent dropdown name
