...
{
    [TestFixture]
    public class T21799317_Microsoft_PowerPoint_2016_Do_Not_Open_Files_In_Unsafe_Locations_In_Protected_View_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Do Not Open Files In Unsafe Locations In Protected View User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21799317");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21799317_Microsoft_PowerPoint_2016_Do_Not_Open_Files_In_Unsafe_Locations_In_Protected_View_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Do not open files in unsafe locations in Protected View (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21799317");
