...
{
    [TestFixture]
    public class T21794365_Microsoft_Office_2016_Disable_UI_Extending_From_Documents_And_Tamplates_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Disable UI Extending From Documents And Tamplates User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21794365");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21794365_Microsoft_Office_2016_Disable_UI_Extending_From_Documents_And_Tamplates_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disable UI extending from documents and templates (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21794365");
