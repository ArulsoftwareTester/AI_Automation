...
{
    [TestFixture]
    public class T21788621_Microsoft_Outlook_2016_Use_Unicode_Format_When_Dragging_E_Mail_Message_To_File_System_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Use Unicode Format When Dragging E Mail Message To File System User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21788621");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21788621_Microsoft_Outlook_2016_Use_Unicode_Format_When_Dragging_E_Mail_Message_To_File_System_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Use Unicode format when dragging e-mail message to file system (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21788621");
