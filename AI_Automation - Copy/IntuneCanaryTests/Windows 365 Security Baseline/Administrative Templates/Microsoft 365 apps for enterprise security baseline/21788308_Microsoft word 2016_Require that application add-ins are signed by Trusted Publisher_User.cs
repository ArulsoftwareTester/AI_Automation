...
namespace IntuneCanaryTests
{
    ...
    public class T21788308_Microsoft_Word_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Word 2016 Require That Application Add Ins Are Signed By Trusted Publisher User Test");
        ...
        public async Task Test_21788308_Microsoft_Word_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21788308");
