...
namespace IntuneCanaryTests
{
    ...
    public class T25228540_Microsoft_Office_2016_Machine_Mime_Sniffing_Safety_Feature : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Mime Sniffing Safety Feature Test");
        ...
        public async Task Test_25228540_Microsoft_Office_2016_Machine_Mime_Sniffing_Safety_Feature()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Mime sniffing safety feature",              // Parent dropdown name
