...
{
    [TestFixture]
    public class T21784303_Microsoft_Outlook_2016_Allow_Users_To_Demote_Attachments_To_Level_2_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Allow Users To Demote Attachments To Level 2 User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21784303");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21784303_Microsoft_Outlook_2016_Allow_Users_To_Demote_Attachments_To_Level_2_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow users to demote attachments to Level 2 (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21784303");
