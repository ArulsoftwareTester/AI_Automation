...
namespace IntuneCanaryTests
{
    ...
    public class T21805057_Microsoft_Publisher_2016_Publisher_Automation_Security_Level_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Publisher 2016 Publisher Automation Security Level User Test");
        ...
        public async Task Test_21805057_Microsoft_Publisher_2016_Publisher_Automation_Security_Level_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Publisher Automation Security level (User)",              // Parent dropdown name
