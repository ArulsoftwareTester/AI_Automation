...
namespace IntuneCanaryTests
{
    ...
    public class T25589772_Microsoft_Excel_2016_Excel_Options_Security : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Security Test");
        ...
        public async Task Test_25589772_Microsoft_Excel_2016_Excel_Options_Security()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Force file extension to match file type (User)",              // Parent dropdown name
