...
{
    [TestFixture]
    public class T21782502_Microsoft_Outlook_2016_Enable_RPC_Encryption_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Enable RPC Encryption User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21782502");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21782502_Microsoft_Outlook_2016_Enable_RPC_Encryption_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Enable RPC encryption (User)",   // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21782502");
