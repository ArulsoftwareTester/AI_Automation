...
namespace IntuneCanaryTests
{
    ...
    public class T25589537_Microsoft_Excel_2016_Excel_Options_Advanced : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Excel 2016 Excel Options Advanced Test");
        ...
        public async Task Test_25589537_Microsoft_Excel_2016_Excel_Options_Advanced()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Ask to update automatic links (User)",              // Parent dropdown name
