...
{
    [TestFixture]
    public class T21789998_Microsoft_Outlook_2016_Minimum_Encryption_Settings_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Minimum Encryption Settings User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21789998");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21789998_Microsoft_Outlook_2016_Minimum_Encryption_Settings_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Minimum encryption settings (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21789998 completed successfully - All configurations tested", "Test_Complete_21789998");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21789998 completed successfully!");
                ...
                Console.WriteLine("Minimum encryption settings");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21789998");
