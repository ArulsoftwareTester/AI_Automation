...
{
    [TestFixture]
    public class T21790280_Microsoft_Outlook_2016_Do_Not_Allow_Outlook_Object_Model_Scripts_To_Run_For_Shared_Folders_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Do Not Allow Outlook Object Model Scripts To Run For Shared Folders User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21790280");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21790280_Microsoft_Outlook_2016_Do_Not_Allow_Outlook_Object_Model_Scripts_To_Run_For_Shared_Folders_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Do not allow Outlook object model scripts to run for shared folders (User)", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21790280");
