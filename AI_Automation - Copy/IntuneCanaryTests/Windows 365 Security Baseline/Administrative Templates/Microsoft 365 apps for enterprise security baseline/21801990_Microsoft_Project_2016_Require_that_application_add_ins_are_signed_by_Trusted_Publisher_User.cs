...
namespace IntuneCanaryTests
{
    ...
    public class T21801990_Microsoft_Project_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Project 2016 Require That Application Add Ins Are Signed By Trusted Publisher User Test");
