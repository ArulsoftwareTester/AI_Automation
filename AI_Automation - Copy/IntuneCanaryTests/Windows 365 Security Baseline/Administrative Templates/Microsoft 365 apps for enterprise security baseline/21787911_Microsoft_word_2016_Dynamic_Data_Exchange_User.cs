...
{
    [TestFixture]
    public class T21787911_Microsoft_Word_2016_Dynamic_Data_Exchange_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Word 2016 Dynamic Data Exchange User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21787911");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21787911_Microsoft_Word_2016_Dynamic_Data_Exchange_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Microsoft Word 2016",
                                                        "Dynamic Data Exchange (User)",   // Parent dropdown name
                                                        "Disabled",                       // Config 1
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                ...
                _test?.Pass("Successfully created NEW Profile with Config 1: Disabled");
                ...
                _test?.Pass("Successfully edited Profile with Config 2: Enabled");
                ...
                await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "Microsoft Word 2016",
                                                        "Dynamic Data Exchange (User)",   // Parent dropdown name
                                                        "Limited Dynamic Data Exchange",  // Config 3
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                                                        "",                               // Parent path
                                                        ""                                // Child path
                                    );
                _test?.Pass("Successfully edited Profile with Config 3: Limited Dynamic Data Exchange");
                ...
                await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "Microsoft Word 2016",
                                                        "Dynamic Data Exchange (User)",   // Parent dropdown name
                                                        "Allow dynamic data exchange",    // Config 4
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                                                        "",                               // Parent path
                                                        ""                                // Child path
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21787911");
