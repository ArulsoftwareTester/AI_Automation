...
{
    [TestFixture]
    public class T21795031_Microsoft_Office_2016_Disabled_All_Trust_Bar_Notifications_For_Security_Issues_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Disabled All Trust Bar Notifications For Security Issues User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21795031");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21795031_Microsoft_Office_2016_Disabled_All_Trust_Bar_Notifications_For_Security_Issues_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disable all Trust Bar notifications for security issues (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21795031");
