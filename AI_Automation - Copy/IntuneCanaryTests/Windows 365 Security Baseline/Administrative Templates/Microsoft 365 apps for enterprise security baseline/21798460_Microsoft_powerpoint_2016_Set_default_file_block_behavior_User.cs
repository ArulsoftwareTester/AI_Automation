...
namespace IntuneCanaryTests
{
    ...
    public class T21798460_Microsoft_PowerPoint_2016_Set_Default_File_Block_Behavior_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Set Default File Block Behavior User Test");
