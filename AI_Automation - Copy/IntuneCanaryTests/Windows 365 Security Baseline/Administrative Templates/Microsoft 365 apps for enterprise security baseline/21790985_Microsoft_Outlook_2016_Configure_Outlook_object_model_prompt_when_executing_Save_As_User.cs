...
{
    [TestFixture]
    public class T21790985_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Executing_Save_As_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Configure Outlook Object Model Prompt When Executing Save As User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21790985");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21790985_Microsoft_Outlook_2016_Configure_Outlook_Object_Model_Prompt_When_Executing_Save_As_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Configure Outlook object model prompt when executing Save As (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21790985 completed successfully - All configurations tested", "Test_Complete_21790985");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21790985");
