...
{
    [TestFixture]
    public class T21779795_Microsoft_Office_2016_Machine_Protection_From_Zone_Elevation : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Protection From Zone Elevation Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21779795");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21779795_Microsoft_Office_2016_Machine_Protection_From_Zone_Elevation()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Protection From Zone Elevation", // Parent dropdown name
                                                        "Enabled",                        // Config 1
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                                                        "",                               // Parent path
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21779795");
