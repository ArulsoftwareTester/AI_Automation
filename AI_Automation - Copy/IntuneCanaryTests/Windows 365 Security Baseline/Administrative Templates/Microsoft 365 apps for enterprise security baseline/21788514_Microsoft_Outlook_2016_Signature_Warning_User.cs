...
{
    [TestFixture]
    public class T21788514_Microsoft_Outlook_2016_Signature_Warning_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Signature Warning User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21788514");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21788514_Microsoft_Outlook_2016_Signature_Warning_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Signature Warning (User)",       // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21788514 completed successfully - All configurations tested", "Test_Complete_21788514");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21788514 completed successfully!");
                ...
                Console.WriteLine("Signature Warning");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21788514");
