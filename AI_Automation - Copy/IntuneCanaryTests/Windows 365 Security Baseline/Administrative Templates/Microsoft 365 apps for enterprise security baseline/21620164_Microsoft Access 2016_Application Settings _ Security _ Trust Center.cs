...
namespace IntuneCanaryTests
{
    ...
    public class T21620164_Microsoft_Access_2016_Application_Settings_Security_Trust_Center : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Access 2016 Application Settings Security Trust Center Test");
        ...
        public async Task Test_21620164_Microsoft_Access_2016_Application_Settings_Security_Trust_Center()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21620164");
