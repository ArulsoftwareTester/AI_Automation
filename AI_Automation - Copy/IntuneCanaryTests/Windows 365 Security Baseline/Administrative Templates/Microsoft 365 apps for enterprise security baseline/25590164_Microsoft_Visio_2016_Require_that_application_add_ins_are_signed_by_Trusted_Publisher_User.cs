...
{
    [TestFixture]
    public class T25590164_Microsoft_Visio_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Visio 2016 Require That Application Add Ins Are Signed By Trusted Publisher User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 25590164");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_25590164_Microsoft_Visio_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User()
        {
                        try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_25590164");
