...
{
    [TestFixture]
    public class T21789176_Microsoft_Outlook_2016_Security_Setting_For_Macros_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Security Setting For Macros User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21789176");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21789176_Microsoft_Outlook_2016_Security_Setting_For_Macros_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Security setting for macros (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21789176 completed successfully - All configurations tested", "Test_Complete_21789176");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21789176 completed successfully!");
                ...
                Console.WriteLine("Security setting for macros");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21789176");
