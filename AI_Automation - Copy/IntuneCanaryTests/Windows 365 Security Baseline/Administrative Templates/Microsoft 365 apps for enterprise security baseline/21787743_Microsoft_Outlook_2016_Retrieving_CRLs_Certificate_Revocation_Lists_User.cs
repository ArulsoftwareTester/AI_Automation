...
{
    [TestFixture]
    public class T21787743_Microsoft_Outlook_2016_Retrieving_CRLs_Certificate_Revocation_Lists_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Outlook 2016 Retrieving CRLs Certificate Revocation Lists User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21787743");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21787743_Microsoft_Outlook_2016_Retrieving_CRLs_Certificate_Revocation_Lists_User()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Retrieving CRLs (Certificate Revocation Lists) (User)", // Child dropdown name
                ...
                await TestInitialize.LogSuccess(Page, "Test 21787743 completed successfully - All configurations tested", "Test_Complete_21787743");
                _test?.Pass("End-to-end test completed successfully with all configurations!");
                
                Console.WriteLine("========================================");
                Console.WriteLine("Test 21787743 completed successfully!");
                ...
                Console.WriteLine("Retrieving CRLs (Certificate Revocation Lists)");
                Console.WriteLine("========================================");
            }
            catch (Exception ex)
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21787743");
