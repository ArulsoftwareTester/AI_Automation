...
{
    [TestFixture]
    public class T21794826_Microsoft_PowerPoint_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Require That Application Add Ins Are Signed By Trusted Publisher User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21794826");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21794826_Microsoft_PowerPoint_2016_Require_That_Application_Add_Ins_Are_Signed_By_Trusted_Publisher_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Require that application add-ins are signed by Trusted Publisher (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21794826");
