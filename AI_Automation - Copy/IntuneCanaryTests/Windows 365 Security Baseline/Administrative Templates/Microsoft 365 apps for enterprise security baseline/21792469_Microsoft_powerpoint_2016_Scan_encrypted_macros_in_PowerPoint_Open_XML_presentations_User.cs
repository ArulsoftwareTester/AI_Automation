...
{
    [TestFixture]
    public class T21792469_Microsoft_PowerPoint_2016_Scan_Encrypted_Macros_In_PowerPoint_Open_XML_Presentations_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft PowerPoint 2016 Scan Encrypted Macros In PowerPoint Open XML Presentations User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21792469");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21792469_Microsoft_PowerPoint_2016_Scan_Encrypted_Macros_In_PowerPoint_Open_XML_Presentations_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Scan encrypted macros in PowerPoint Open XML presentations (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21792469");
