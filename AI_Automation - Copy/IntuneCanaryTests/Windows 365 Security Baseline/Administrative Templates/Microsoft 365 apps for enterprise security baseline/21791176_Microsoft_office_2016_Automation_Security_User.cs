...
namespace IntuneCanaryTests
{
    ...
    public class T21791176_Microsoft_Office_2016_Automation_Security_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Automation Security User Test");
        ...
        public async Task Test_21791176_Microsoft_Office_2016_Automation_Security_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Automation Security (User)",              // Parent dropdown name
