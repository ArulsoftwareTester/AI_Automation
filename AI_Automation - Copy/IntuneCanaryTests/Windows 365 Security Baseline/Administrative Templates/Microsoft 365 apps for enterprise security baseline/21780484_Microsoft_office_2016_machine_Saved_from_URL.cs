...
{
    [TestFixture]
    public class T21780484_Microsoft_Office_2016_Machine_Saved_From_URL : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Machine Saved From URL Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21780484");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21780484_Microsoft_Office_2016_Machine_Saved_From_URL()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Saved from URL",                 // Parent dropdown name
                                                        "Enabled",                        // Config 1
                                                        "",                               // No child dropdown
                                                        "",                               // No child value
                                                        "",                               // Parent path
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21780484");
