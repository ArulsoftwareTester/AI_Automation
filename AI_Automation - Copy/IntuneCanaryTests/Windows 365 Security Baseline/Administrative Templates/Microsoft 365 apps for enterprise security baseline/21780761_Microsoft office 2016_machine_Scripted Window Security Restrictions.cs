...
namespace IntuneCanaryTests
{
    ...
    public class T21780761_Microsoft_Office_2016_Machine_Scripted_Window_Security_Restrictions : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Microsoft Office 2016 Machine Scripted Window Security Restrictions Test");
        ...
        public async Task Test_21780761_Microsoft_Office_2016_Machine_Scripted_Window_Security_Restrictions()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_21780761");
