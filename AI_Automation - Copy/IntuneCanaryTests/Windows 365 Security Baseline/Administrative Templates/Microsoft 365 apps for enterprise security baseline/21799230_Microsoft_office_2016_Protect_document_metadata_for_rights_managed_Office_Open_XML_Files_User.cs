...
{
    [TestFixture]
    public class T21799230_Microsoft_Office_2016_Protect_Document_Metadata_For_Rights_Managed_Office_Open_XML_Files_User : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Microsoft 365 Apps for Enterprise Security Baseline - Microsoft Office 2016 Protect Document Metadata For Rights Managed Office Open XML Files User Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 21799230");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_21799230_Microsoft_Office_2016_Protect_Document_Metadata_For_Rights_Managed_Office_Open_XML_Files_User()
        {
                        try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Protect document metadata for rights managed Office Open XML Files (User)",              // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_21799230");
