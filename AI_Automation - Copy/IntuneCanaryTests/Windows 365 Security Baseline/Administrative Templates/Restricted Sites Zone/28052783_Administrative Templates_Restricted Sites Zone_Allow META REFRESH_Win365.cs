...
{
    [TestFixture]
    public class T28052783_AllowMetaRefresh : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow META REFRESH Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28052783");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052783_AllowMetaRefresh()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow META REFRESH",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow META REFRESH", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052783");
