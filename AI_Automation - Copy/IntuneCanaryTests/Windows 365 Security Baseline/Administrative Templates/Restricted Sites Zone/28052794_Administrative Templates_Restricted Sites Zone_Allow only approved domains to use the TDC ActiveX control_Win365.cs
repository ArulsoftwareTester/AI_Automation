...
{
    [TestFixture]
    public class T28052794_AllowOnlyApprovedDomainsToUseTDCActiveXControl : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052794");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052794_AllowOnlyApprovedDomainsToUseTDCActiveXControl()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow only approved domains to use the TDC ActiveX control", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052794");
