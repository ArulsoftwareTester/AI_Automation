...
{
    [TestFixture]
    public class T28052962_EnableDraggingOfContentFromDifferentDomainsAcrossWindows : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052962");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052962_EnableDraggingOfContentFromDifferentDomainsAcrossWindows()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052962");
