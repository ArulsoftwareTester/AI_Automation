...
{
    [TestFixture]
    public class T28053202_AdministrativeTemplates_RestrictedSitesZone_ScriptActiveXControlsMarkedSafeForScripting : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Script ActiveX controls marked safe for scripting Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28053202");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053202_AdministrativeTemplates_RestrictedSitesZone_ScriptActiveXControlsMarkedSafeForScripting()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Script ActiveX controls marked safe for scripting",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Script ActiveX controls marked safe for scripting", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053202");
