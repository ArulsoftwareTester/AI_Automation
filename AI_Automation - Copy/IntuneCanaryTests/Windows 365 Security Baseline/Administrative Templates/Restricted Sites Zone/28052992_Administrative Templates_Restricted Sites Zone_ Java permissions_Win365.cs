...
{
    [TestFixture]
    public class T28052992_AdministrativeTemplates_RestrictedSitesZone_JavaPermissions : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052992");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28052992_AdministrativeTemplates_RestrictedSitesZone_JavaPermissions()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052992");
