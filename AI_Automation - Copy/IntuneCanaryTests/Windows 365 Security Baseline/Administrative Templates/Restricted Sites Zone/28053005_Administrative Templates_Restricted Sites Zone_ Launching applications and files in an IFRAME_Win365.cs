...
{
    [TestFixture]
    public class T28053005_AdministrativeTemplates_RestrictedSitesZone_LaunchingApplicationsAndFilesInAnIFRAME : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28053005");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053005_AdministrativeTemplates_RestrictedSitesZone_LaunchingApplicationsAndFilesInAnIFRAME()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053005");
