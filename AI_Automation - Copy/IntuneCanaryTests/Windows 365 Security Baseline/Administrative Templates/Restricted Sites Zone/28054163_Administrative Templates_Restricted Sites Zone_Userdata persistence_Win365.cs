...
{
    [TestFixture]
    public class T28054163_AdministrativeTemplates_RestrictedSitesZone_UserdataPersistence : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054163");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054163_AdministrativeTemplates_RestrictedSitesZone_UserdataPersistence()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054163");
