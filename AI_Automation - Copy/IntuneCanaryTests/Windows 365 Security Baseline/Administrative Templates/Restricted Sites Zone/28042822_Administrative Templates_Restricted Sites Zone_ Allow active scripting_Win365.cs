...
{
    [TestFixture]
    public class T28042822_AllowActiveScripting : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow active scripting Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28042822");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042822_AllowActiveScripting()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow active scripting",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow active scripting", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042822");
