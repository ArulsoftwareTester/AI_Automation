...
{
    [TestFixture]
    public class T28054177_AdministrativeTemplates_RestrictedSitesZone_WebSitesInLessPrivilegedWebContentZonesCanNavigateIntoThisZone : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054177");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054177_AdministrativeTemplates_RestrictedSitesZone_WebSitesInLessPrivilegedWebContentZonesCanNavigateIntoThisZone()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054177");
