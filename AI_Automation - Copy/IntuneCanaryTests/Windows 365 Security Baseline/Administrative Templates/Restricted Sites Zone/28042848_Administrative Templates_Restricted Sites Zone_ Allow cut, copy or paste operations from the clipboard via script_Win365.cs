...
{
    [TestFixture]
    public class T28042848_AllowCutCopyPasteFromClipboardViaScript : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28042848");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042848_AllowCutCopyPasteFromClipboardViaScript()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042848");
