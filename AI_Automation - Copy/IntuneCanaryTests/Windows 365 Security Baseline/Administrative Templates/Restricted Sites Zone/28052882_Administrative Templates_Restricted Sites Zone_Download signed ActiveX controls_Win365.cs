...
{
    [TestFixture]
    public class T28052882_DownloadSignedActiveXControls : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052882");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052882_DownloadSignedActiveXControls()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052882");
