...
{
    [TestFixture]
    public class T28042679_AccessDataSourcesAcrossDomains : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28042679");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042679_AccessDataSourcesAcrossDomains()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042679");
