...
{
    [TestFixture]
    public class T28041070_AllowScriptInitiatedWindowsWithoutSizeOrPositionConstraints : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28041070");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041070_AllowScriptInitiatedWindowsWithoutSizeOrPositionConstraints()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041070");
