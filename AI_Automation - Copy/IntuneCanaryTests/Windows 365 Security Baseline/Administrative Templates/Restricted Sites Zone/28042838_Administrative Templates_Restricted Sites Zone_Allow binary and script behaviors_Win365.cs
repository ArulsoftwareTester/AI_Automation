...
{
    [TestFixture]
    public class T28042838_AllowBinaryAndScriptBehaviors : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow binary and script behaviors Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28042838");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042838_AllowBinaryAndScriptBehaviors()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow binary and script behaviors",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow Binary and Script Behaviors", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042838");
