...
{
    [TestFixture]
    public class T28042872_AllowFileDownloads : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow file downloads Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28042872");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042872_AllowFileDownloads()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow file downloads",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow file downloads", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042872");
