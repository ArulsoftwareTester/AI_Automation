...
{
    [TestFixture]
    public class T28042347_AdministrativeTemplates_RestrictedSitesZone_ShowSecurityWarningForPotentiallyUnsafeFiles : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28042347");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28042347_AdministrativeTemplates_RestrictedSitesZone_ShowSecurityWarningForPotentiallyUnsafeFiles()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Show security warning for potentially unsafe files", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042347");
