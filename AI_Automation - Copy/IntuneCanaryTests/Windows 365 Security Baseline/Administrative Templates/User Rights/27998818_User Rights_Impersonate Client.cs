...
{
    [TestFixture]
    public class T27998818_User_Rights_Impersonate_Client : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "User Rights - Impersonate Client");
        ...
        [Test]
        public async Task Test_27998818_User_Rights_Impersonate_Client()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27998818");
