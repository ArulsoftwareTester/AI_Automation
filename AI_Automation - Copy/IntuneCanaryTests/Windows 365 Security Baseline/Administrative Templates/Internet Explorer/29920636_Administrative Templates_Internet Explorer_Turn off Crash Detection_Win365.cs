...
{
    [TestFixture]
    public class T29920636_TurnOffCrashDetection : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Turn off Crash Detection Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29920636");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29920636_TurnOffCrashDetection()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn off Crash Detection",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29920636");
