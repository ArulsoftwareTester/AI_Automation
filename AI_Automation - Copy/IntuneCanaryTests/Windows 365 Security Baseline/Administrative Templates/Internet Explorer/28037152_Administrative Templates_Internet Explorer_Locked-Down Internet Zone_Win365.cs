...
{
    [TestFixture]
    public class T28037152_LockeddownInternetZone : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Locked-Down Internet Zone Test");
        ...
        [Test]
        public async Task Test_28037152_LockeddownInternetZone()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Internet Zone",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Internet Zone"   // Child path
                                                    );    
