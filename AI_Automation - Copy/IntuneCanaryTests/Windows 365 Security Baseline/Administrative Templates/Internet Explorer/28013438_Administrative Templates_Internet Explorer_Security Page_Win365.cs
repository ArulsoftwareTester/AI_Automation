...
{
    [TestFixture]
    public class T28013438_SecurityPage : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Security Page Test");
        ...
        [Test]
        public async Task Test_28013438_SecurityPage()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Intranet Sites: Include all network paths (UNCs)",   // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Turn on certificate address mismatch warning", // Child dropdown name
                                                        "Enabled",                        // Child dropdown value
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page"   // Child path
                                                    );    
