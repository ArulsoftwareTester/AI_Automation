...
{
    [TestFixture]
    public class T29890079_CheckForSignaturesOnDownloadedPrograms : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Check for signatures on downloaded programs Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29890079");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29890079_CheckForSignaturesOnDownloadedPrograms()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Check for signatures on downloaded programs",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29890079");
