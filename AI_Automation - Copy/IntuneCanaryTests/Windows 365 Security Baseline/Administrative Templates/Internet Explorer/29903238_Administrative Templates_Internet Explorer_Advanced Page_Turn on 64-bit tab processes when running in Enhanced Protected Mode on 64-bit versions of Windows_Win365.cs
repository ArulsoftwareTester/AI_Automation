...
{
    [TestFixture]
    public class T29903238_TurnOn64BitTabProcessesWhenRunningInEPMOn64Bit : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Turn on 64-bit tab processes when running in Enhanced Protected Mode on 64-bit versions of Windows Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29903238");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29903238_TurnOn64BitTabProcessesWhenRunningInEPMOn64Bit()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "",
                                                        "",
                                                        "Windows Components > Internet Explorer > Internet Settings > Advanced Page",
                                                        "Windows Components > Internet Explorer > Internet Settings > Advanced Page"
                                                    );    
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29903238");
