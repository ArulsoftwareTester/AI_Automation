...
{
    [TestFixture]
    public class T29889962_CheckForServerCertificateRevocation : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Check for server certificate revocation Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29889962");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29889962_CheckForServerCertificateRevocation()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Check for server certificate revocation",   // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Check for server certificate revocation", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29889962");
