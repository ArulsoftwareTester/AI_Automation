...
{
    [TestFixture]
    public class T29949760_JavaPermissions : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Java permissions Test");
        ...
        [Test]
        public async Task Test_29949760_JavaPermissions()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Local Machine Zone",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Local Machine Zone"   // Child path
                                                    );    
