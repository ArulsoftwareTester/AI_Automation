...
{
    [TestFixture]
    public class T28037524_RestrictFileDownload : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Restrict File Download Test");
        ...
        [Test]
        public async Task Test_28037524_RestrictFileDownload()
        {
            try
            {
               ...
               await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Security Features > Restrict File Download",  // Parent path
                                                        "Windows Components > Internet Explorer > Security Features > Restrict File Download"   // Child path
                                                    );    
