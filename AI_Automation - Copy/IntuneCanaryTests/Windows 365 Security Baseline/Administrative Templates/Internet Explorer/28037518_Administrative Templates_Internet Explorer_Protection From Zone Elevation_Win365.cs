...
{
    [TestFixture]
    public class T28037518_ProtectionFromZoneElevation : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Protection From Zone Elevation Test");
        ...
        [Test]
        public async Task Test_28037518_ProtectionFromZoneElevation()
        {
            try
            {
