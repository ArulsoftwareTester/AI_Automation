...
{
    [TestFixture]
    public class T29903504_PreventBypassingSmartScreenFilterWarningsAboutFilesNotCommonlyDownloaded : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Prevent bypassing SmartScreen Filter warnings about files that are not commonly downloaded from the Internet Test");
        ...
        [Test]
        public async Task Test_29903504_PreventBypassingSmartScreenFilterWarningsAboutFilesNotCommonlyDownloaded()
        {
            try
            {
