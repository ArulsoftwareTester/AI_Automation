...
{
    [TestFixture]
    public class T28037340_DoNotAllowUsersToAdddeleteSites : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Do not allow users to add/delete sites Test");
        ...
        [Test]
        public async Task Test_28037340_DoNotAllowUsersToAdddeleteSites()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Do not allow users to add/delete sites",   // Parent dropdown name
