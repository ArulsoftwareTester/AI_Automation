...
{
    [TestFixture]
    public class T28037442_MimeSniffingSafetyFeature : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Mime Sniffing Safety Feature Test");
        ...
        [Test]
        public async Task Test_28037442_MimeSniffingSafetyFeature()
        {
            try
            {
