...
{
    [TestFixture]
    public class T29904641_PreventBypassingSmartscreenFilterWarnings : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Prevent bypassing SmartScreen Filter warnings Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29904641");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29904641_PreventBypassingSmartscreenFilterWarnings()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Prevent bypassing SmartScreen Filter warnings",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29904641");
