...
{
    [TestFixture]
    public class T29903271_TurnOnEnhancedProtectedMode : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Turn on Enhanced Protected Mode Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29903271");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29903271_TurnOnEnhancedProtectedMode()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn on Enhanced Protected Mode",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29903271");
