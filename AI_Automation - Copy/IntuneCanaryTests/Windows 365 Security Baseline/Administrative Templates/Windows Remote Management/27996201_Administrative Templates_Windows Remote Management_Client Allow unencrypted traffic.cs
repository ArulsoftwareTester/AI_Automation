...
{
    [TestFixture]
    public class ClientAllowUnencryptedTraffic : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security baseline - Administrative Templates - Windows Remote Management - Client Allow unencrypted traffic Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27996201");
            _test.Info("Category: Administrative Templates - Windows Remote Management");
        }


        [Test]
        public async Task Test_27996201_AdministrativeTemplatesWindowsRemoteManagementClientAllowUnencryptedTraffic()
        {
            try
            {
                Console.WriteLine("Test_27996201_AdministrativeTemplatesWindowsRemoteManagementClientAllowUnencryptedTraffic started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27996201");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27996201");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27996201");
