...
{
    [TestFixture]
    public class T28040969_AllowDragDropOrCopyPasteFiles : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow drag and drop or copy and paste files Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28040969");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28040969_AllowDragDropOrCopyPasteFiles()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28040969");
