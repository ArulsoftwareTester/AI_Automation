...
{
    [TestFixture]
    public class T28041794_DownloadSignedActiveXControls : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Download signed ActiveX controls Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28041794");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041794_DownloadSignedActiveXControls()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Download signed ActiveX controls",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Download signed ActiveX controls", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041794");
