...
{
    [TestFixture]
    public class T28041148_AllowScriptlets : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow scriptlets Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28041148");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041148_AllowScriptlets()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow scriptlets",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Scriptlets", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041148");
