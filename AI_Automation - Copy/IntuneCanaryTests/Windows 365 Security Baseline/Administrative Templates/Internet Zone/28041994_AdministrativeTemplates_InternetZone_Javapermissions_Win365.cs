...
{
    [TestFixture]
    public class T28041994_JavaPermissions : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28041994");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041994_JavaPermissions()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041994");
