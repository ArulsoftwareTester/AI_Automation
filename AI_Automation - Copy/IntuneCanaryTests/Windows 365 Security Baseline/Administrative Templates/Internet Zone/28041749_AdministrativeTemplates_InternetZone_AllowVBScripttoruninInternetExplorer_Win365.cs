...
{
    [TestFixture]
    public class T28041749_AllowVBScriptToRunInInternetExplorer : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow VBScript to run in Internet Explorer Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28041749");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041749_AllowVBScriptToRunInInternetExplorer()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow VBScript to run in Internet Explorer",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow VBScript to run in Internet Explorer", // Child dropdown name
...
await securityBaseline.editNewCreatedPolicy(
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041749");
