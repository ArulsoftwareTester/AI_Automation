...
{
    [TestFixture]
    public class T28040921_AccessDataSourcesAcrossDomains : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Access data sources across domains Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28040921");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28040921_AccessDataSourcesAcrossDomains()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Access data sources across domains",  // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Access data sources across domains", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28040921");
