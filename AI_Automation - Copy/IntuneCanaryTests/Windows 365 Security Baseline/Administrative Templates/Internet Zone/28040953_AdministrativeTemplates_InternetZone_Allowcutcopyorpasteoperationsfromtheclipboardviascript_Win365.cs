...
{
    [TestFixture]
    public class T28040953_AllowCutCopyPasteFromClipboardViaScript : PageTest
    {
        ...
        [Test]
        public async Task Test_28040953_AllowCutCopyPasteFromClipboardViaScript()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow cut, copy or paste operations from the clipboard via script",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Allow paste operations via script", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28040953");
