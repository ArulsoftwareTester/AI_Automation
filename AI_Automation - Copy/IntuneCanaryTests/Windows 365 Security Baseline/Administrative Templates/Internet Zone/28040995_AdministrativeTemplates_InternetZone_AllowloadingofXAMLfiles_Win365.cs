...
{
    [TestFixture]
    public class T28040995_AllowLoadingOfXamlFiles : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Allow loading of XAML files Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28040995");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28040995_AllowLoadingOfXamlFiles()
        {
            try
            {
_test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow loading of XAML files",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "XAML Files", // Child dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28040995");
