...
{
    [TestFixture]
    public class ServiceAllowUnencryptedTraffic : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security baseline - Administrative Templates - Windows Remote Management - Service Allow unencrypted traffic Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27996209");
            _test.Info("Category: Administrative Templates - Windows Remote Management");
        }


        [Test]
        public async Task Test_27996209_AdministrativeTemplatesWindowsRemoteManagementServiceAllowUnencryptedTraffic()
        {
            try
            {
                Console.WriteLine("Test_27996209_AdministrativeTemplatesWindowsRemoteManagementServiceAllowUnencryptedTraffic started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27996209");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27996209");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27996209");
