...
{
    [TestFixture]
    public class DisallowDigestAuthentication : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security baseline - Administrative Templates - Windows Remote Management - Disallow Digest authentication Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27984348");
            _test.Info("Category: Administrative Templates - Windows Remote Management");
        }


        [Test]
        public async Task Test_27984348_AdministrativeTemplatesWindowsRemoteManagementDisallowDigestAuthentication()
        {
            try
            {
                Console.WriteLine("Test_27984348_AdministrativeTemplatesWindowsRemoteManagementDisallowDigestAuthentication started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27984348");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27984348");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27984348");
