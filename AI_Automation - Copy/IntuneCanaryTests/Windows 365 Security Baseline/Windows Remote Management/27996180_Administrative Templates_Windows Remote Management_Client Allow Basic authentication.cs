...
{
    [TestFixture]
    public class ClientAllowBasicAuthentication : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security baseline - Administrative Templates - Windows Remote Management - Client Allow Basic authentication Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27996180");
            _test.Info("Category: Administrative Templates - Windows Remote Management");
        }


        [Test]
        public async Task Test_27996180_AdministrativeTemplatesWindowsRemoteManagementClientAllowBasicAuthentication()
        {
            try
            {
                Console.WriteLine("Test_27996180_AdministrativeTemplatesWindowsRemoteManagementClientAllowBasicAuthentication started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27996180");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27996180");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27996180");
