...
{
    [TestFixture]
    public class DeviceLock_27998335_DevicePasswordEnabled : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Device Lock: Device Password Enabled");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998335");
            _test.Info("Category: Security Baseline - Device Lock");
        }

        [Test]
        public async Task Test_27998335_DeviceLock_DevicePasswordEnabled()
        {
            try
            {
