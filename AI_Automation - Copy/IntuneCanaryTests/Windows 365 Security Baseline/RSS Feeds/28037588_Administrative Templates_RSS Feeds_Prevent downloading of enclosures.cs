...
{
    [TestFixture]
    public class PreventDownloadingOfEnclosures : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Administrative Templates - RSS Feeds - Prevent downloading of enclosures Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28037588");
            _test.Info("Category: Administrative Templates - RSS Feeds");
        }


        [Test]
        public async Task Test_28037588_AdministrativeTemplatesRSSFeedsPreventDownloadingOfEnclosures()
        {
            try
            {
                Console.WriteLine("Test_28037588_AdministrativeTemplatesRSSFeedsPreventDownloadingOfEnclosures started...");
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_28037588");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_28037588");
