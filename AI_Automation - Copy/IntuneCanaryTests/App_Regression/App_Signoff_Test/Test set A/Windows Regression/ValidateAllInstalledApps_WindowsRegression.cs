...
namespace IntuneCanaryTests
{
    [TestFixture]
    [Order(int.MaxValue)]
    public class ValidateAllInstalledApps_WindowsRegression
    {
        ...
        public void TestSetup()
        {
            _test = TestInitialize.CreateTest(
                ...
                "Validate All Installed Apps - Windows Regression");
            _test.Info("Category: Test set A - Windows Regression - Batch Validation");
        }
        ...
        public async Task ValidateAllPackagesViaWinget()
        {
            ...
            _test?.Pass("All Windows Regression app installation validations passed!");
        }
