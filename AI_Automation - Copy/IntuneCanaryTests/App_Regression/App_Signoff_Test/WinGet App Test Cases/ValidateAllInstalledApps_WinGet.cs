...
namespace IntuneCanaryTests
{
    [TestFixture]
    [Order(int.MaxValue)]
    public class ValidateAllInstalledApps_WinGet
    {
        ...
        public void TestSetup()
        {
            _test = TestInitialize.CreateTest(
                ...
                "Validate All Installed Apps - WinGet App Test Cases");
            _test.Info("Category: WinGet App Test Cases - Batch Validation");
        }
        ...
        public async Task ValidateAllPackagesViaWinget()
        {
            ...
            _test?.Pass("All WinGet app installation validations passed!");
        }
