...
{
    [TestFixture]
    public class TaskScheduler_28008864_EnableXboxGameSaveTask : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Task Scheduler: Enable Xbox Game Save Task");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28008864");
            _test.Info("Category: Windows 365 Security Baseline - Task Scheduler");
        }

        [Test]
        public async Task Test_28008864_TaskScheduler_EnableXboxGameSaveTask()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Enable Xbox Game Save Task setting");
                ...
                _test?.Pass("Successfully edited Security Baseline for Windows 10 and later Profile - changed setting to Disabled");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28008864");
