...
{
    [TestFixture]
    public class Defender_27995802_Win10_BlockUntrustedAndUnsignedProcessesThatRunFromUSB : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Block untrusted and unsigned processes that run from USB");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27995802");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27995802_Defender_Win10_BlockUntrustedAndUnsignedProcessesThatRunFromUSB()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Block untrusted and unsigned processes that run from USB");
                ...
                _test?.Pass("Successfully created NEW Profile for Block untrusted and unsigned processes that run from USB"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27995802");
                ...
                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Block_27995802");
                ...
                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27995802");
                ...
                var editScreenshot3 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Warn_27995802");
                ...
                // var editScreenshot4 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_NotConfigured_27995802");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27995802");
