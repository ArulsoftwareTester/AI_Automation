...
{
    [TestFixture]
    public class Defender_27995708_Win10_AllowCloudProtection : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Allow Cloud Protection");
        ...
        [Test]
        public async Task Test_27995708_Defender_Win10_AllowCloudProtection()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Allow Cloud Protection");
                ...
                _test?.Pass("Successfully created NEW Profile for Allow Cloud Protection"); 
                ...
                _test?.Info("Step 3: Editing Profile - Changing Allow Cloud Protection to Disabled");
                ...
                _test?.Pass("Successfully edited Profile - Allow Cloud Protection set to Disabled");

                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Disabled_27995708");
