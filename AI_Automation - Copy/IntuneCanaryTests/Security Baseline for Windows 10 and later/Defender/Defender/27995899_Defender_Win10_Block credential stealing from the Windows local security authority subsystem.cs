...
{
    [TestFixture]
    public class Defender_27995899_Win10_BlockCredentialStealingFromTheWindowsLocalSecurityAuthoritySubsystem : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Block credential stealing from the Windows local security authority subsystem");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27995899");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27995899_Defender_Win10_BlockCredentialStealingFromTheWindowsLocalSecurityAuthoritySubsystem()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Block credential stealing from the Windows local security authority subsystem");
                ...
                _test?.Pass("Successfully created NEW Profile for Block credential stealing from the Windows local security authority subsystem"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27995899");
                ...
                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Block_27995899");
                ...
                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27995899");
                ...
                var editScreenshot3 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Warn_27995899");
                ...
                // var editScreenshot4 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_NotConfigured_27995899");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27995899");
