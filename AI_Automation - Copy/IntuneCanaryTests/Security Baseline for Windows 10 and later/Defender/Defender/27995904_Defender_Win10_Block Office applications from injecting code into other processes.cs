...
{
    [TestFixture]
    public class Defender_27995904_Win10_BlockOfficeApplicationsFromInjectingCodeIntoOtherProcesses : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Block Office applications from injecting code into other processes");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27995904");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27995904_Defender_Win10_BlockOfficeApplicationsFromInjectingCodeIntoOtherProcesses()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Block Office applications from injecting code into other processes");
                ...
                _test?.Pass("Successfully created NEW Profile for Block Office applications from injecting code into other processes"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27995904");
                ...
                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Block_27995904");
                ...
                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27995904");
                ...
                var editScreenshot3 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Warn_27995904");
                ...
                // var editScreenshot4 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_NotConfigured_27995904");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27995904");
