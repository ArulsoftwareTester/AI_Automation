...
{
    [TestFixture]
    public class Defender_31491616_Win10_OobeEnableRtpAndSigUpdate : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Oobe Enable Rtp And Sig Update");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 31491616");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_31491616_Defender_Win10_OobeEnableRtpAndSigUpdate()
        {
            try
            {
                ...
                _test?.Info("Step 3: Editing Profile - Changing Hide Exclusions From Local Users");
                ...
                _test?.Pass("Successfully edited Profile - Hide Exclusions From Local Users set");
