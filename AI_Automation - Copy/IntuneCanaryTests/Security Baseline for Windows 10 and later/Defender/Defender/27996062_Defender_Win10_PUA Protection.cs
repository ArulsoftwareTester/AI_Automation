...
{
    [TestFixture]
    public class Defender_27996062_Win10_PUAProtection : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: PUA Protection");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27996062");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27996062_Defender_Win10_PUAProtection()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - PUA Protection");
                ...
                _test?.Pass("Successfully created NEW Profile for PUA Protection"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27996062");
                ...
                _test?.Info("Step 3: Editing Profile - Changing PUA Protection to On");
                ...
                _test?.Pass("Successfully edited Profile - PUA Protection set to On");

                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_On_27996062");
                ...
                _test?.Info("Step 4: Editing Profile - Changing PUA Protection to Audit");
                await securityBaseline.editNewCreatedPolicy(
                    Page,
                    "Endpoint security",
                    "Security baselines",
                ...
                _test?.Pass("Successfully edited Profile - PUA Protection set to Audit");

                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27996062");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27996062");
