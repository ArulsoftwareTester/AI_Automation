...
{
    [TestFixture]
    public class Defender_27995909_Win10_BlockExecutableContentFromEmailClientAndWebmail : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Block executable content from email client and webmail");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27995909");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27995909_Defender_Win10_BlockExecutableContentFromEmailClientAndWebmail()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Block executable content from email client and webmail");
                ...
                _test?.Pass("Successfully created NEW Profile for Block executable content from email client and webmail"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27995909");
                ...
                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Block_27995909");
                ...
                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27995909");
                ...
                var editScreenshot3 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Warn_27995909");
                ...
                // var editScreenshot4 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_NotConfigured_27995909");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27995909");
