    ...
    public class Defender_27894675_Win10_AllowArchiveScanning : PageTest
    {
        ...
        public async Task Test_27894675_Defender_Win10_AllowArchiveScanning()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Allow Archive Scanning");
                ...
                _test?.Pass("Successfully created NEW Profile for Allow Archive Scanning"); 
                ...
                _test?.Info("Step 3: Editing Profile - Changing Allow Archive Scanning to Disabled");
                ...
                _test?.Pass("Successfully edited Profile - Allow Archive Scanning set to Disabled");

                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_27894675");
