...
{
    [TestFixture]
    public class Defender_27995784_Win10_BlockWin32APICallsFromOfficeMacros : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Defender: Block Win32 API calls from Office macros");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27995784");
            _test.Info("Category: Security Baseline for Windows 10 and later - Defender");
        }

        [Test]
        public async Task Test_27995784_Defender_Win10_BlockWin32APICallsFromOfficeMacros()
        {
            try
            {
                ...
                _test?.Info("Step 2: Creating NEW Profile for Defender - Block Win32 API calls from Office macros");
                ...
                _test?.Pass("Successfully created NEW Profile for Block Win32 API calls from Office macros"); 

                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27995784");
                ...
                var editScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Block_27995784");
                ...
                var editScreenshot2 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Audit_27995784");
                ...
                var editScreenshot3 = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Edited_Warn_27995784");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27995784");
