...
{
    [TestFixture]
    public class T27866829_AuditAuthenticationPolicyChange : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Auditing - Audit Authentication Policy Change");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27866829");
            _test.Info("Category: Auditing");
        }

        [Test]
        public async Task Test_27866829_AuditAuthenticationPolicyChange()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27866829");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27866829");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27866829");
