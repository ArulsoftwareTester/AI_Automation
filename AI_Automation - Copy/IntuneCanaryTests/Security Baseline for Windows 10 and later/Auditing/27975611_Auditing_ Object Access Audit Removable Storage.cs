...
{
    [TestFixture]
    public class T27975611_ObjectAccessAuditRemovableStorage : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Auditing - Object Access Audit Removable Storage");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27975611");
            _test.Info("Category: Auditing");
        }

        [Test]
        public async Task Test_27975611_ObjectAccessAuditRemovableStorage()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_27975611");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_27975611");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27975611");
