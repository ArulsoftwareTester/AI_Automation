...
{
    [TestFixture]
    public class Kerberos_31491597_PKInitHashAlgorithmSHA1 : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Kerberos: PK Init Hash Algorithm SHA1");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 31491597");
            _test.Info("Category: Security Baseline for Windows 10 and later - Kerberos");
        }

        [Test]
        public async Task Test_31491597_Kerberos_PKInitHashAlgorithmSHA1()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with PK Init Hash Algorithm SHA1 setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_31491597");
