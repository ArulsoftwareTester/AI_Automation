...
{
    [TestFixture]
    public class Test_27997533_MicrosoftDefenderAntivirus_ScanPackedExecutables : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Microsoft Defender Antivirus - Scan packed executables");
        ...
        [Test]
        public async Task Test_27997533_MicrosoftDefenderAntivirus_ScanPackedExecutables()
        {
            try
            {
                Console.WriteLine("Test_27997533_MicrosoftDefenderAntivirus_ScanPackedExecutables started...");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Scan packed executables",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "", // Child dropdown name
                                                        "",                        // Child dropdown value
                                                        "Windows Components > Microsoft Defender Antivirus > Scan",  // Parent path
                                                        "Windows Components > Microsoft Defender Antivirus > Scan"   // Child path
                                                    );    
