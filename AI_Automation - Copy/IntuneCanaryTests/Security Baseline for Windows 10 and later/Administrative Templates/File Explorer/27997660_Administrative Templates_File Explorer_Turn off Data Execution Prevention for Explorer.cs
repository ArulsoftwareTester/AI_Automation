...
namespace IntuneCanaryTests
{
    ...
    public class TurnOffDataExecutionPreventionForExplorer : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - File Explorer - Turn off Data Execution Prevention for Explorer Test");
        ...
        public async Task Test_27997660_AdministrativeTemplatesFileExplorerTurnOffDataExecutionPreventionForExplorer()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn off Data Execution Prevention for Explorer",              // Parent dropdown name
