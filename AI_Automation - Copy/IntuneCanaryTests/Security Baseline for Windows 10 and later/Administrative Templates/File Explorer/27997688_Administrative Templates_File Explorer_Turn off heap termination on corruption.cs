...
namespace IntuneCanaryTests
{
    ...
    public class TurnOffHeapTerminationOnCorruption : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - File Explorer - Turn off heap termination on corruption Test");
        ...
        public async Task Test_27997688_AdministrativeTemplatesFileExplorerTurnOffHeapTerminationOnCorruption()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn off heap termination on corruption",              // Parent dropdown name
