...
{
    [TestFixture]
    public class T28053192_AdministrativeTemplates_RestrictedSitesZone_RunActiveXControlsAndPlugins : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Run ActiveX controls and plugins Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28053192");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053192_AdministrativeTemplates_RestrictedSitesZone_RunActiveXControlsAndPlugins()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Run ActiveX controls and plugins",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Run ActiveX controls and plugins", // Child dropdown name
                ...
                await securityBaseline.editNewCreatedPolicy(
                                           ...
                                           await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "Enabled",                        // Parent dropdown value
                                                        "Run ActiveX controls and plugins", // Child dropdown name
                                                        "Administrator approved",                        // Child dropdown value
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Restricted Sites Zone",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Restricted Sites Zone"   // Child path
                                    );
                await securityBaseline.editNewCreatedPolicy(
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053192");
