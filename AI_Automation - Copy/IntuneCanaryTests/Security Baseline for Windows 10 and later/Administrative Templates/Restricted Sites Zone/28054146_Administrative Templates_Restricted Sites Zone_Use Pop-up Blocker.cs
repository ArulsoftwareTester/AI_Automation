...
{
    [TestFixture]
    public class T28054146_AdministrativeTemplates_RestrictedSitesZone_UsePopupBlocker : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054146");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054146_AdministrativeTemplates_RestrictedSitesZone_UsePopupBlocker()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054146");
