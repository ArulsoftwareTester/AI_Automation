...
{
    [TestFixture]
    public class T28052861_AutomaticPromptingForFileDownloads : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052861");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052861_AutomaticPromptingForFileDownloads()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052861");
