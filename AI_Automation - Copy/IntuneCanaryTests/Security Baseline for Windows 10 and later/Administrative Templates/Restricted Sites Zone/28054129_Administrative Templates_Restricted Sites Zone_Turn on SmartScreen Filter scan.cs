...
{
    [TestFixture]
    public class T28054129_AdministrativeTemplates_RestrictedSitesZone_TurnOnSmartScreenFilterScan : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054129");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054129_AdministrativeTemplates_RestrictedSitesZone_TurnOnSmartScreenFilterScan()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054129");
