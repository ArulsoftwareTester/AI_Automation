...
{
    [TestFixture]
    public class T28042902_AllowLoadingOfXamlFiles : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28042902");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042902_AllowLoadingOfXamlFiles()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042902");
