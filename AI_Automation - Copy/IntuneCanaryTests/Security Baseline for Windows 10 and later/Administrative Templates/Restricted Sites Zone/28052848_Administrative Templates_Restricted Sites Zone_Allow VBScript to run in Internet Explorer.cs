...
{
    [TestFixture]
    public class T28052848_AllowVBScriptToRunInInternetExplorer : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052848");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052848_AllowVBScriptToRunInInternetExplorer()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052848");
