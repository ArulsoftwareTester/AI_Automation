...
{
    [TestFixture]
    public class T28052980_IncludeLocalPathWhenUserIsUploadingFilesToAServer : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052980");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052980_IncludeLocalPathWhenUserIsUploadingFilesToAServer()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052980");
