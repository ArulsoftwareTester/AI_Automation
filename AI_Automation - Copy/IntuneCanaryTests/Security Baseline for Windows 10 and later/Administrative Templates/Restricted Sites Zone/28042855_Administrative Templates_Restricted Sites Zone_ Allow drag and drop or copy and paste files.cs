...
{
    [TestFixture]
    public class T28042855_AllowDragDropOrCopyPasteFiles : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28042855");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28042855_AllowDragDropOrCopyPasteFiles()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28042855");
