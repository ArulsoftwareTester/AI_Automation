...
{
    [TestFixture]
    public class T28053009_AdministrativeTemplates_RestrictedSitesZone_LogonOptions : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28053009");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053009_AdministrativeTemplates_RestrictedSitesZone_LogonOptions()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053009");
