...
{
    [TestFixture]
    public class T28052985_InitializeAndScriptActiveXControlsNotMarkedAsSafe : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052985");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052985_InitializeAndScriptActiveXControlsNotMarkedAsSafe()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052985");
