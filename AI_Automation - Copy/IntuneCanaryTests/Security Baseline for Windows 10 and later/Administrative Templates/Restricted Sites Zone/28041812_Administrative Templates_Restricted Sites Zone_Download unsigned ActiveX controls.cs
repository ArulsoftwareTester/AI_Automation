...
{
    [TestFixture]
    public class T28041812_DownloadUnsignedActiveXControls : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28041812");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28041812_DownloadUnsignedActiveXControls()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28041812");
