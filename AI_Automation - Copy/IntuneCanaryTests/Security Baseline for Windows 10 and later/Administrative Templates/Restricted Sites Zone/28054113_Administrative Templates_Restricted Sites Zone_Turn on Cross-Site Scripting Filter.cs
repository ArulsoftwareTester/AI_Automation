...
{
    [TestFixture]
    public class T28054113_AdministrativeTemplates_RestrictedSitesZone_TurnOnCrossSiteScriptingFilter : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054113");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054113_AdministrativeTemplates_RestrictedSitesZone_TurnOnCrossSiteScriptingFilter()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054113");
