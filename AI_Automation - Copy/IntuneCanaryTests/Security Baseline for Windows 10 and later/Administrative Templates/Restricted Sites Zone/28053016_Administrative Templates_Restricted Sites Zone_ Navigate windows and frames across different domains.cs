...
{
    [TestFixture]
    public class T28053016_AdministrativeTemplates_RestrictedSitesZone_NavigateWindowsAndFramesAcrossDifferentDomains : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28053016");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053016_AdministrativeTemplates_RestrictedSitesZone_NavigateWindowsAndFramesAcrossDifferentDomains()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053016");
