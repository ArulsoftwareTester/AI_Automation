...
{
    [TestFixture]
    public class T28054119_AdministrativeTemplates_RestrictedSitesZone_TurnOnProtectedMode : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28054119");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28054119_AdministrativeTemplates_RestrictedSitesZone_TurnOnProtectedMode()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28054119");
