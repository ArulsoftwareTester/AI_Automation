...
{
    [TestFixture]
    public class T28053061_AdministrativeTemplates_RestrictedSitesZone_RunDotNETFrameworkReliantComponentsSignedWithAuthenticode : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28053061");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053061_AdministrativeTemplates_RestrictedSitesZone_RunDotNETFrameworkReliantComponentsSignedWithAuthenticode()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053061");
