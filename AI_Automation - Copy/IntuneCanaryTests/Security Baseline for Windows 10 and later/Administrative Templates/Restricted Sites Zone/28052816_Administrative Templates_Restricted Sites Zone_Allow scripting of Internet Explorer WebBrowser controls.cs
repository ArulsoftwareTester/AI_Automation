...
{
    [TestFixture]
    public class T28052816_AllowScriptingOfIEWebBrowserControls : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052816");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052816_AllowScriptingOfIEWebBrowserControls()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052816");
