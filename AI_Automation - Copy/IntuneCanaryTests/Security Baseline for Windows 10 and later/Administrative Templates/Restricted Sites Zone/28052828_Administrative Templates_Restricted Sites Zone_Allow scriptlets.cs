...
{
    [TestFixture]
    public class T28052828_AllowScriptlets : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28052828");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28052828_AllowScriptlets()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28052828");
