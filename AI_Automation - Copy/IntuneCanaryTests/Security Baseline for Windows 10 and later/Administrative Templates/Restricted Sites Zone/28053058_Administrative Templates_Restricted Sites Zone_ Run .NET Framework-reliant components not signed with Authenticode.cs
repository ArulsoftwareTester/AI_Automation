...
{
    [TestFixture]
    public class T28053058_RunDotNETFrameworkReliantComponentsNotSignedWithAuthenticode : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28053058");
            _test.Info("Category: Security Baseline Configuration - Restricted Sites Zone");
        }

        [Test]
        public async Task Test_28053058_RunDotNETFrameworkReliantComponentsNotSignedWithAuthenticode()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28053058");
