...
{
    [TestFixture]
    public class T29920390_UseOnlyMachineSettings : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Use only machine settings Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29920390");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29920390_UseOnlyMachineSettings()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Security Zones: Use only machine settings",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29920390");
