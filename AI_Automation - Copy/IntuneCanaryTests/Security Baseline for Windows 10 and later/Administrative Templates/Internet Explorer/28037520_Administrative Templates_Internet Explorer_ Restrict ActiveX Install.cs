...
{
    [TestFixture]
    public class RestrictActiveXInstall : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - Internet Explorer - Restrict ActiveX Install Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28037520");
        }
        [Test]
        public async Task Test_28037520_AdministrativeTemplatesInternetExplorerRestrictActiveXInstall()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_28037520");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_28037520");
