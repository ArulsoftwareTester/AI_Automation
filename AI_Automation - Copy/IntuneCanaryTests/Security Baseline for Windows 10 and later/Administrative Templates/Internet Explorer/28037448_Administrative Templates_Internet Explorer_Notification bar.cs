...
{
    [TestFixture]
    public class T28037448_NotificationBar : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Notification bar Test");
        ...
        [Test]
        public async Task Test_28037448_NotificationBar()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Security Features > Notification bar",  // Parent path
                                                        "Windows Components > Internet Explorer > Security Features > Notification bar"   // Child path
                                                    );    
