...
{
    [TestFixture]
    public class T28037233_LockeddownTrustedSitesZone : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Locked-Down Trusted Sites Zone Test");
        ...
        [Test]
        public async Task Test_28037233_LockeddownTrustedSitesZone()
        {
            try
            {
              ...
              await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Trusted Sites Zone",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Trusted Sites Zone"   // Child path
                                                    );    
