...
{
    [TestFixture]
    public class T28037525_ScriptedWindowSecurityRestrictions : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Scripted Window Security Restrictions Test");
        ...
        [Test]
        public async Task Test_28037525_ScriptedWindowSecurityRestrictions()
        {
            try
            {
