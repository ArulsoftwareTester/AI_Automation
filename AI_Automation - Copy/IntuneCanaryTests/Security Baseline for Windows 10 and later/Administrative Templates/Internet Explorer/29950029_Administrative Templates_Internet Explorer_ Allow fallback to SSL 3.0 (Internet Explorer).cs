...
{
    [TestFixture]
    public class AllowFallbackToSSL3InternetExplorer : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - Internet Explorer - Allow fallback to SSL 3.0 (Internet Explorer) Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29950029");
        }
        [Test]
        public async Task Test_29950029_AdministrativeTemplatesInternetExplorerAllowFallbackToSSL3InternetExplorer()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_29950029");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_29950029");
