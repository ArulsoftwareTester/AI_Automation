...
{
    [TestFixture]
    public class T28037410_ConsistentMimeHandling : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Consistent Mime Handling Test");
        ...
        [Test]
        public async Task Test_28037410_ConsistentMimeHandling()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Security Features > Consistent Mime Handling",  // Parent path
                                                        "Windows Components > Internet Explorer > Security Features > Consistent Mime Handling"   // Child path
                                                    );    
