...
{
    [TestFixture]
    public class T28766165_AllowFallbackToSsl30InternetExplorer : PageTest
    {
        ...
        public void TestSetup()
        {
            ...
            _test.Info("Test ID: 28766165");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28766165_AllowFallbackToSsl30InternetExplorer()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28766165");
