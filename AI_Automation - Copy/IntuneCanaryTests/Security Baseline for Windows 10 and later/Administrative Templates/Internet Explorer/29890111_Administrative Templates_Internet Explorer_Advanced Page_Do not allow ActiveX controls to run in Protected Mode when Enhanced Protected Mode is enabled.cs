...
{
    [TestFixture]
    public class T29890111_DoNotAllowActiveXInProtectedModeWhenEnhancedProtectedModeEnabled : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Do not allow ActiveX controls to run in Protected Mode when Enhanced Protected Mode is enabled Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29890111");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29890111_DoNotAllowActiveXInProtectedModeWhenEnhancedProtectedModeEnabled()
        {
            try
            {
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29890111");
