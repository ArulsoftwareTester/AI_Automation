...
{
    [TestFixture]
    public class T29903530_PreventManagingSmartscreenFilter : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Prevent managing SmartScreen Filter Test");
        ...
        [Test]
        public async Task Test_29903530_PreventManagingSmartscreenFilter()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Prevent managing SmartScreen Filter",   // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Select SmartScreen Filter mode", // Child dropdown name
