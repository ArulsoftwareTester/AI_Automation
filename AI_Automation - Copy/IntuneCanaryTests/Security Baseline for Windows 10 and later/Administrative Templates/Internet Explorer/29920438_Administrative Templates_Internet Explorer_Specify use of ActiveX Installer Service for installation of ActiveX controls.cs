...
{
    [TestFixture]
    public class T29920438_SpecifyUseOfActivexInstallerServiceForInstallation : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Specify use of ActiveX Installer Service for installation of ActiveX controls Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29920438");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29920438_SpecifyUseOfActivexInstallerServiceForInstallation()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Specify use of ActiveX Installer Service for installation of ActiveX controls",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29920438");
