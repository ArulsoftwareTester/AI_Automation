...
{
    [TestFixture]
    public class T29920650_TurnOnTheAutocompleteFeatureForUserNamesAndPasswor : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Turn on the auto-complete feature for user names and passwords on forms (User) Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29920650");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29920650_TurnOnTheAutocompleteFeatureForUserNamesAndPasswor()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn on the auto-complete feature for user names and passwords on forms (User)",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29920650");
