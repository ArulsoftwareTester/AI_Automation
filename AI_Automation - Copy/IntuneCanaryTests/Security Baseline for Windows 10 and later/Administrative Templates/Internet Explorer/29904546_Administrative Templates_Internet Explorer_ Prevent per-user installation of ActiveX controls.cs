...
{
    [TestFixture]
    public class PreventPerUserInstallationOfActiveXControls : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - Internet Explorer - Prevent per-user installation of ActiveX controls Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29904546");
        }
        [Test]
        public async Task Test_29904546_AdministrativeTemplatesInternetExplorerPreventPerUserInstallationOfActiveXControls()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_29904546");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_29904546");
