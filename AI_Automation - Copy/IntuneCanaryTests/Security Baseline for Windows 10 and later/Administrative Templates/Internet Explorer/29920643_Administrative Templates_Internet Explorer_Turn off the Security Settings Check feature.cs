...
{
    [TestFixture]
    public class T29920643_TurnOffTheSecuritySettingsCheckFeature : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Turn off the Security Settings Check feature Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29920643");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_29920643_TurnOffTheSecuritySettingsCheckFeature()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Turn off the Security Settings Check feature",   // Parent dropdown name
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29920643");
