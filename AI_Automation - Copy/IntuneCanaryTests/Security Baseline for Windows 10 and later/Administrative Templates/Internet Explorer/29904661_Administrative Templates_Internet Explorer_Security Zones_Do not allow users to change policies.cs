...
{
    [TestFixture]
    public class T29904661_DoNotAllowUsersToChangePolicies : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Do not allow users to change policies Test");
        ...
        [Test]
        public async Task Test_29904661_DoNotAllowUsersToChangePolicies()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Security Zones: Do not allow users to change policies",   // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "", // Child dropdown name
                                                        "",                        // Child dropdown value
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Security Zones",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Security Zones"   // Child path
                                                    );    
