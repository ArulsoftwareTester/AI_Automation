...
{
    [TestFixture]
    public class PreventManagingSmartScreenFilter : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - Administrative Templates - Internet Explorer - Prevent managing SmartScreen Filter Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 29903530");
        }
        [Test]
        public async Task Test_29903530_AdministrativeTemplatesInternetExplorerPreventManagingSmartScreenFilter()
        {
            try
            {
                ...
                var loginScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Login_Complete_29903530");
                ...
                var profileScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Profile_Created_29903530");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_29903530");
