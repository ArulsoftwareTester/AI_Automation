...
{
    [TestFixture]
    public class T28037372_AddonManagement : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Windows 365 Security Baseline - Add-on Management Test");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 28037372");
            _test.Info("Category: Security Baseline Configuration");
        }

        [Test]
        public async Task Test_28037372_AddonManagement()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Remove \"Run this time\" button for outdated ActiveX controls in Internet Explorer",   // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Turn off blocking of outdated ActiveX controls for Internet Explorer", // Child dropdown name
                                                        "Enabled",                        // Child dropdown value
                                                        "Windows Components > Internet Explorer > Security Features > Add-on Management",  // Parent path
                                                        "Windows Components > Internet Explorer > Security Features > Add-on Management"   // Child path
                                                    );    
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_28037372");
