...
{
    [TestFixture]
    public class T28037225_TurnOnSmartscreenFilterScan : PageTest
    {
        ...
        [Test]
        public async Task Test_28037225_TurnOnSmartscreenFilterScan()
        {
            try
            {
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Restricted Sites Zone",  // Parent path
                                                        "Windows Components > Internet Explorer > Internet Control Panel > Security Page > Locked-Down Restricted Sites Zone"   // Child path
                                                    );    
