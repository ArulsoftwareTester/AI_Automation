...
{
    [TestFixture]
    public class T27996209_ServiceAllowUnencryptedTraffic : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Service Allow unencrypted traffic");
        ...
        [Test]
        public async Task Test_27996209_ServiceAllowUnencryptedTraffic()
        {
            try
            {
 _test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow unencrypted traffic",              // Parent dropdown name
