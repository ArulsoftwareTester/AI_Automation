...
{
    [TestFixture]
    public class T27996201_ClientAllowUnencryptedTraffic : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Client Allow unencrypted traffic");
        ...
        [Test]
        public async Task Test_27996201_ClientAllowUnencryptedTraffic()
        {
            try
            {
