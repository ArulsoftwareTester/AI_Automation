...
{
    [TestFixture]
    public class T27984348_DisallowDigestAuthentication : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Disallow Digest authentication");
        ...
        [Test]
        public async Task Test_27984348_DisallowDigestAuthentication()
        {
            try
            {
 _test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disallow Digest authentication",              // Parent dropdown name
