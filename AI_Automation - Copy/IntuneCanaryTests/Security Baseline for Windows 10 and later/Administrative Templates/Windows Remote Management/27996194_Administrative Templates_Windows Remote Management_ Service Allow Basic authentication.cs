...
{
    [TestFixture]
    public class T27996194_ServiceAllowBasicAuthentication : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Service Allow Basic authentication");
        ...
        [Test]
        public async Task Test_27996194_ServiceAllowBasicAuthentication()
        {
            try
            {
 _test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Allow Basic authentication",              // Parent dropdown name
                ...
                await securityBaseline.editNewCreatedPolicy(
                                                        ...
                                                        "", // Child dropdown name
                                                        "",                        // Child dropdown value
                                                        "Windows Components > Windows Remote Management (WinRM) > WinRM Client",  // Parent path
                                                        "Windows Components > Windows Remote Management (WinRM) > WinRM Client"   // Child path
                                    );
