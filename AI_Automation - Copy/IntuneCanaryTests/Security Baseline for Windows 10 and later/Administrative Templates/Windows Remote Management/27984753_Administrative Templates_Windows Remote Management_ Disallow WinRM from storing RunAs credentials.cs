...
{
    [TestFixture]
    public class T27984753_DisallowWinRMFromStoringRunAsCredentials : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Disallow WinRM from storing RunAs credentials");
        ...
        [Test]
        public async Task Test_27984753_DisallowWinRMFromStoringRunAsCredentials()
        {
            try
            {
 _test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Disallow WinRM from storing RunAs credentials",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "", // Child dropdown name
                                                        "",                        // Child dropdown value
                                                        "Windows Components > Windows Remote Management (WinRM) > WinRM Service",  // Parent path
                                                        "Windows Components > Windows Remote Management (WinRM) > WinRM Service"   // Child path
                                                    );    
