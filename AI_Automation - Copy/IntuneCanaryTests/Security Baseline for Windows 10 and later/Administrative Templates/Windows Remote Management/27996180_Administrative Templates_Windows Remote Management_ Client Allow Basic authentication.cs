...
{
    [TestFixture]
    public class T27996180_ClientAllowBasicAuthentication : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows Remote Management - Client Allow Basic authentication");
        ...
        [Test]
        public async Task Test_27996180_ClientAllowBasicAuthentication()
        {
            try
            {
