...
{
    [TestFixture]
    public class T27980024_PowerShellScriptBlockLogging : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline - Windows PowerShell - PowerShell script block logging");
        ...
        [Test]
        public async Task Test_27980024_PowerShellScriptBlockLogging()
        {
            try
            {
 _test?.Info("Step 1: Logging into Intune Portal");
                ...
                await securityBaseline.CreateNewProfile(
                                                        ...
                                                        "Windows PowerShell",
                                                        "Turn on PowerShell Script Block Logging",              // Parent dropdown name
                                                        "Enabled",                        // Parent dropdown value
                                                        "Log script block invocation start / stop events:", // Child dropdown name
                                                        "Off",                        // Child dropdown value
                                                        "Windows Components > Windows PowerShell",  // Parent path
                                                        "Windows Components > Windows PowerShell"   // Child path
                                                    );    
