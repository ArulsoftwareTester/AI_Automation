...
{
    [TestFixture]
    public class UserRights_27998859_TakeOwnership : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Take Ownership");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998859");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998859_UserRights_TakeOwnership()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Take Ownership setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998859");
