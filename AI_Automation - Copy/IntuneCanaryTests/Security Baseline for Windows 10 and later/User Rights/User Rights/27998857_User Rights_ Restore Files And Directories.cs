...
{
    [TestFixture]
    public class UserRights_27998857_RestoreFilesAndDirectories : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Restore Files And Directories");
        ...
        [Test]
        public async Task Test_27998857_UserRights_RestoreFilesAndDirectories()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Restore Files And Directories setting");
