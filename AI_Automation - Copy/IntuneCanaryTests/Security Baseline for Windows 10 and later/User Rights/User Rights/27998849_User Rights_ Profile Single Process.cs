...
{
    [TestFixture]
    public class UserRights_27998849_ProfileSingleProcess : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Profile Single Process");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998849");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998849_UserRights_ProfileSingleProcess()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Profile Single Process setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998849");
