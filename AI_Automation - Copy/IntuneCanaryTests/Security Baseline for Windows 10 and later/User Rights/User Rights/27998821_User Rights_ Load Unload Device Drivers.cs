...
{
    [TestFixture]
    public class UserRights_27998821_LoadUnloadDeviceDrivers : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Load Unload Device Drivers");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998821");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998821_UserRights_LoadUnloadDeviceDrivers()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Load Unload Device Drivers setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998821");
