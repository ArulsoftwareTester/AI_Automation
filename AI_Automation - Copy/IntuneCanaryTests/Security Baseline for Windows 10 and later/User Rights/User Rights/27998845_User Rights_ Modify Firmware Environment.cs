...
{
    [TestFixture]
    public class UserRights_27998845_ModifyFirmwareEnvironment : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Modify Firmware Environment");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998845");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998845_UserRights_ModifyFirmwareEnvironment()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Modify Firmware Environment setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998845");
