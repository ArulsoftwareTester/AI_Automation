...
{
    [TestFixture]
    public class UserRights_27998793_CreateGlobalObjects : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Create Global Objects");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998793");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998793_UserRights_CreateGlobalObjects()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Create Global Objects setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998793");
