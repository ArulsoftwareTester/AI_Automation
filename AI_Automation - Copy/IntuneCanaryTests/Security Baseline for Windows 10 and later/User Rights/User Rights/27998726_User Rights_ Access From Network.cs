...
{
    [TestFixture]
    public class UserRights_27998726_AccessFromNetwork : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Access From Network");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998726");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998726_UserRights_AccessFromNetwork()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Access From Network setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998726");
