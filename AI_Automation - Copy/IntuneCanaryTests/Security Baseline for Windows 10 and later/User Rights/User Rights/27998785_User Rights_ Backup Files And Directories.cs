...
{
    [TestFixture]
    public class UserRights_27998785_BackupFilesAndDirectories : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Backup Files And Directories");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998785");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998785_UserRights_BackupFilesAndDirectories()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Backup Files And Directories setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998785");
