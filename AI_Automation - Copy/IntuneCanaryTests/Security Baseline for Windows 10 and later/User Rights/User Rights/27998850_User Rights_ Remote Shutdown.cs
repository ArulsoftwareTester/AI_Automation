...
{
    [TestFixture]
    public class UserRights_27998850_RemoteShutdown : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Remote Shutdown");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998850");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998850_UserRights_RemoteShutdown()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Remote Shutdown setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998850");
