...
{
    [TestFixture]
    public class UserRights_27998808_DebugPrograms : PageTest
    {
        ...
        {
            _test = TestInitialize.CreateTest(TestContext.CurrentContext.Test.Name, "Security Baseline for Windows 10 and later - User Rights: Debug Programs");
            _test.Info($"Test started at: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
            _test.Info("Test ID: 27998808");
            _test.Info("Category: Security Baseline for Windows 10 and later - User Rights");
        }

        [Test]
        public async Task Test_27998808_UserRights_DebugPrograms()
        {
            try
            {
                ...
                _test?.Info("Step 2: Create new Security Baseline profile with Debug Programs setting");
            ...
            {
                var errorScreenshot = await ExtentReportHelper.CaptureScreenshot(Page, "Error_27998808");
