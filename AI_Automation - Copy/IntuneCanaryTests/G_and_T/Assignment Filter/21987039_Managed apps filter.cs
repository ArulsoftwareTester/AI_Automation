...
{
    public class Test_21987039_Managed_apps_filter : PageTest
    {
        ...
        [Test]
        public async Task ManagedAppsFilter()
        {
            Console.WriteLine("Starting test: 21987039_Managed apps filter");
