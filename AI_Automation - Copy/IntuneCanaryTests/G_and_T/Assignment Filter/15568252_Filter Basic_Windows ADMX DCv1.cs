...
{
    public class Test_15568252_Filter_Basic_Windows_ADMX_DCv1 : PageTest
    {
        ...
        [Test]
        public async Task FilterBasic_WindowsADMXDCv1()
        {
            Console.WriteLine("Starting test: 15568252_Filter Basic_Windows ADMX DCv1");
