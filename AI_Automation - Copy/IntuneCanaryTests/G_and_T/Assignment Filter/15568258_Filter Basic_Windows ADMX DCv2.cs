...
{
    public class Test_15568258_Filter_Basic_Windows_ADMX_DCv2 : PageTest
    {
        ...
        [Test]
        public async Task FilterBasic_WindowsADMXDCv2()
        {
            Console.WriteLine("Starting test: 15568258_Filter Basic_Windows ADMX DCv2");
