...
{
    public class Test_15539571_Create_Filter_by_Rule_syntax : PageTest
    {
        ...
        [Test]
        public async Task CreateFilterByRuleSyntax()
        {
            Console.WriteLine("Starting test: 15539571_Create Filter by Rule syntax");
