...
{
    public class Test_15539171_Create_Filter_by_rule_builder : PageTest
    {
        ...
        [Test]
        public async Task CreateFilterByRuleBuilder()
        {
            Console.WriteLine("Starting test: 15539171_Create Filter by rule builder");
