...
{
    [TestFixture]
    public class _651442_Settings_Kiosk_policy_properly_restricts_user_from_opening_any_other_non_kiosk_app_OldSvcNewClient: PageTest
    {
        [Test]
        public async Task Test_651442_Settings_Kiosk_policy_properly_restricts_user_from_opening_any_other_non_kiosk_app_OldSvcNewClient()
        {
