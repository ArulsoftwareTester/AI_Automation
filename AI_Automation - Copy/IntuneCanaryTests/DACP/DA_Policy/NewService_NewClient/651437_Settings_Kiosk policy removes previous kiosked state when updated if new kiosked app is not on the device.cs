...
{
    [TestFixture]
    public class _651437_Settings_Kiosk_policy_removes_previous_kiosked_state_when_updated_if_new_kiosked_app_is_not_on_the_device_NewSvcNewClient: PageTest
    {
        [Test]
        public async Task Test_651437_Settings_Kiosk_policy_removes_previous_kiosked_state_when_updated_if_new_kiosked_app_is_not_on_the_device_NewSvcNewClient()
        {
