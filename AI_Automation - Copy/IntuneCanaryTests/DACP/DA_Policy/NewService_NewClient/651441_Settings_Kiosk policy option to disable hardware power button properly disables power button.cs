...
{
    [TestFixture]
    public class _651441_Settings_Kiosk_policy_option_to_disable_hardware_power_button_properly_disables_power_button_NewSvcNewClient: PageTest
    {
        [Test]
        public async Task Test_651441_Settings_Kiosk_policy_option_to_disable_hardware_power_button_properly_disables_power_button_NewSvcNewClient()
        {
