...
{
    [TestFixture]
    public class _3614062_Settings_Knox_Device_Default_password_type_NewSvcNewClient: PageTest
    {
        [Test]
        public async Task Test_3614062_Settings_Knox_Device_Default_password_type_NewSvcNewClient()
        {
