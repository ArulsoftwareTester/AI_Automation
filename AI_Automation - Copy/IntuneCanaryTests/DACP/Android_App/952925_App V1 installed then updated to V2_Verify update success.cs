...
{
    public class _952925_App_V1_installed_then_updated_to_V2_Verify_update_success : PageTest
    {
    ...
    public async Task IPLogin(IPage page)
    {
        ...
        [Test]
        public async Task _952925_App_V1_installed_then_updated_to_V2_Verify_update_success_Test()
        {
            Console.WriteLine("Starting test: 952925 - App V1 installed then updated to V2_Verify update success");
