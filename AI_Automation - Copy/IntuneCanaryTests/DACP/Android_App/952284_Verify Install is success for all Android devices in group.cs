...
{
    public class _952284_Verify_Install_is_success_for_all_Android_devices_in_group : PageTest
    {
    ...
    public async Task IPLogin(IPage page)
    {
        ...
        [Test]
        public async Task _952284_Verify_Install_is_success_for_all_Android_devices_in_group_Test()
        {
            Console.WriteLine("Starting test: 952284 - Verify Install is success for all Android devices in group");
