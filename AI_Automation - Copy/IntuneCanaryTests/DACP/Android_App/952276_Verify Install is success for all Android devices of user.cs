...
{
    public class _952276_Verify_Install_is_success_for_all_Android_devices_of_user : PageTest
    {
    ...
    public async Task IPLogin(IPage page)
    {
        ...
        [Test]
        public async Task _952276_Verify_Install_is_success_for_all_Android_devices_of_user_Test()
        {
            Console.WriteLine("Starting test: 952276 - Verify Install is success for all Android devices of user");
