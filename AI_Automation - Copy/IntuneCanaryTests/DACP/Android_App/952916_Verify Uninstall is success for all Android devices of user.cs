...
{
    public class _952916_Verify_Uninstall_is_success_for_all_Android_devices_of_user : PageTest
    {
    ...
    public async Task IPLogin(IPage page)
    {
        ...
        [Test]
        public async Task _952916_Verify_Uninstall_is_success_for_all_Android_devices_of_user_Test()
        {
            Console.WriteLine("Starting test: 952916 - Verify Uninstall is success for all Android devices of user");
