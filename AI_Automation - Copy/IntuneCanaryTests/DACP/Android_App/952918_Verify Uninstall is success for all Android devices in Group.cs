...
{
    public class _952918_Verify_Uninstall_is_success_for_all_Android_devices_in_Group : PageTest
    {
    ...
    public async Task IPLogin(IPage page)
    {
        ...
        [Test]
        public async Task _952918_Verify_Uninstall_is_success_for_all_Android_devices_in_Group_Test()
        {
            Console.WriteLine("Starting test: 952918 - Verify Uninstall is success for all Android devices in Group");
